...
//$baseUrl = 'http://localhost/gosocialcms/app/webroot/js/ckfinder/userfiles/';
$baseUrl = $_SERVER['DOCUMENT_ROOT'].'app/webroot/images/';
...
*/
$baseDir = resolveUrl($baseUrl);
//$baseDir ='D:/xampp/htdocs/gosocialcms/app/webroot/js/ckfinder/userfiles/';
