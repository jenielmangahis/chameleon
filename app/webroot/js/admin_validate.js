...
function validatecompany(actionfor){
      ...
      if(isNaN($('#lat').val()))
       ...
       { 
          ...
          inlineMsg('lat','<strong>Please enter valid latitude.</strong>',2);
    ...
    if($('#long').val() !=''){
      ...
      { 
        ...
        inlineMsg('long','<strong>Please enter valid longitude.</strong>',2);
...
function validatecontactslos(actionfor){
 ...
 * Function name   : validsetting()

 * Description     : This function is used for validation of setup Form (add/edit)
...
function validsetting(){
	...
	if ($('#ProjectProjectName').val()=='') {
		...
		inlineMsg('ProjectProjectName','<strong>Please Provide Project Name.</strong>',2);
	...
	if ($('#AdminEmail').val()=='' ) {
		...
		inlineMsg('AdminEmail','<strong>Please Provide Email.</strong>',2);
	...
	if(validateemail($('#AdminEmail').val())==false){
		...
		inlineMsg('AdminEmail','<strong>Please Provide valid Email.</strong>',2);
	...
	if ($('#ProjectAddress1').val()=='') {

		inlineMsg('ProjectAddress1','<strong>Please Provide Address1.</strong>',2);
	...
	if ($('#country').val()=='' || $('#country').val()=='0' ) {
		...
		inlineMsg('state','<strong>Please Select Country.</strong>',2);
	...
	if ($('#ProjectZipcode').val()=='') {

		inlineMsg('ProjectZipcode','<strong>Please Provide ZipCode.</strong>',2);
	...
	if ( $('#AdminUsername').val() == '') {
		...
		inlineMsg('AdminUsername','<strong>Please Provide Login Id</strong>',2);
...
function validatelocation(){
	...
	if ($('#LocationLocationName').val()=='') {

		inlineMsg('LocationLocationName','<strong>Please Provide Locaion Name.</strong>',2);
	...
	if ($('#LocationAddress1').val()=='') {

		inlineMsg('LocationAddress1','<strong>Please Provide Address1.</strong>',2);
	...
	if ($('#LocationZipcode').val()=='') {
		...
		inlineMsg('LocationZipcode','<strong>Please Provide ZipCode.</strong>',2);
	...
	if ($('#LocationCity').val()=='') {
		...
		inlineMsg('LocationCity','<strong>Please Provide City.</strong>',2);
