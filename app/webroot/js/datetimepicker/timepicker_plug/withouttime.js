	 ...
	 // Slider
		...
		//Inline editor bind
				...
				function writeDate (text,type) {
					...
					/*customize by brijesh for button purpose*/
					var str = $('#pickerplug').data('inputfield').id;
					var newStrfieldid = str.substring(0, str.length-2);
					...
					if(document.getElementById('datesubmitchipco')){
