...
(function() {
	...
	(function() {
		...
		a.nd = "\154\x6f";
		a.jG = "\x68\x6f";
		a.hf = new window["\122\145\x67\105\170\x70"](
															...
															.sendCommand(
																	...
																	function(t) {
																		...
																		q.config.thumbsEnabled = t
																				.selectSingleNode(v
																						+ "\x40\x74\150\x75\x6d\x62\163\105\x6e\141\142\x6c\x65\144").value == 'true';
																		q.config.thumbsDirectAccess = false;
																		if (q.config.thumbsEnabled) {
																			u = t
																					.selectSingleNode(v
																							+ "\100\164\x68\x75\x6d\x62\x73\125\x72\154");
																			if (u)
																				q.config.thumbsUrl = u.value;
																			u = t
																					.selectSingleNode(v
																							+ "\x40\164\150\x75\155\x62\163\104\x69\x72\x65\x63\x74\101\143\143\x65\x73\x73");
																			if (u)
																				q.config.thumbsDirectAccess = u.value == 'true';
																			u = t
																					.selectSingleNode(v
																							+ "\100\x74\150\x75\x6d\142\x73\127\x69\x64\164\x68");
																			...
																			u = t
																					.selectSingleNode(v
																							+ "\100\x74\x68\x75\155\x62\163\110\x65\151\x67\150\x74");
																		...
																		q.config.imagesMaxWidth = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\100\x69\155\x67\127\151\x64\x74\150").value,
																				10);
																		q.config.imagesMaxHeight = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\x40\151\x6d\147\x48\x65\151\x67\150\164").value,
																				10);
																		u = t
																				.selectSingleNode(v
																						+ "\100\165\160\154\x6f\141\144\115\141\170\x53\151\x7a\145");
																		...
																		u = t
																				.selectSingleNode(v
																						+ "\100\x75\x70\154\x6f\x61\144\103\150\145\x63\x6b\x49\x6d\141\147\145\163");
																		q.config.uploadCheckImages = u ? u.value == 'true'
																				: false;
																		var w = t
																				.selectSingleNode(v
																						+ "\x40\160\x6c\x75\147\x69\156\x73"), x = w
																				&& w.value;
																		if (x
																				&& x.length)
																			m
	...
	(function() {
		...
		function y() {
			return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5
					&& window.top[a.nd + "\x63\141\164\x69\x6f\x6e"][a.jG
									...
									if (a.bF
										...
										for ( var C = 0; C < A.count(); C++) {
											if (A
													.getItem(C)
													.rd(
															"\x70\x6f\163\151\x74\151\x6f\156") == "\x73\x74\141\x74\151\x63")
												B = 1;
										}
										if (!B)
											this
													...
													.appendHtml(
															y || z || w != 4 ? r
																	: s
																			...
																			+ i
																					.htmlEncode(a.ed)
																			+ "\x3c\057\142\x3e\x3c\x2f\144\151\166\076");
									}
