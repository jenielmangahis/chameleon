...
function validateprojecttype(part){
     ...
     if($('#defaultdeliverydays').val() == '')
     {
         inlineMsg('defaultdeliverydays','<strong>Please provide default delivery days</strong>',2);
         return false;
     }
...
function validateproject(part){
    ...
    */
         ...
         else  
         {
             ...
             {
                 //alert("ch2");
                 inlineMsg('email','<strong>Please provide correct Sponsor Email</strong>',2);
                 return false;
             }
         }
...
function ajaxuniqueprojectname(projectname){	
	...
	$.ajax({
			type: "GET",
			cache: false,
			url: '/admins/uniquesystemname/'+projectname,
 ...
 function ajaxuniquesystemname(systemname){    
    ...
    $.ajax({
            type: "GET",
            cache: false,
            url: '/admins/uniqueprojectname/'+systemname,
            success: function(output){ 
            document.getElementById("loadingdivimg").style.display="none"; 
            //alert(output);
                if(output>0)
 ...
 function ajaxuniquesponsorname(sponsorname){    
    ...
    $.ajax({
            type: "GET",
            cache: false,
            url: '/admins/uniquesponsorusername/'+sponsorname,
            success: function(output){ 
            document.getElementById("loadingdivimg").style.display="none"; 
            //alert(output);
                if(output>0)
...
function findgetstates(countryid,modelname) {
       ...
       jQuery.ajax({
             type: "GET",
             url: '/admins/findselectstate/'+countryid+'/'+modelname,
             cache: false,
...
function getstateoptions(countryid,modelname) {    
       ...
       jQuery.ajax({
             type: "GET",
             url: '/admins/selectstateoptions/'+countryid+'/'+modelname,
             cache: false,
             success: function(rText){
...
function projectstates(countryid,modelname) {
       ...
       jQuery.ajax({
             type: "GET",
             url: '/admins/projectstate/'+countryid+'/'+modelname,
             cache: false,
             success: function(rText){
                    //alert(rText);
...
function newgetstates(countryid,modelname) {  
       ...
       jQuery.ajax({
             type: "GET",
             url: '/admins/newselectstate/'+countryid+'/'+modelname,
             cache: false,
             success: function(rText){
...
function getproducttypedays(pricetypeoptionsid) {
     ...
     document.getElementById("producttypedeliverydays").value = "";
      jQuery.ajax({
         type: "GET",
         url: '/admins/getproducttypedays/'+pricetypeoptionsid,
         cache: false,
         success: function(rText){
                   if(rText){
...
function getemailtemplatesbyajax(projectid,eleid, selectedid,extra) {    
       ...
       if(extra)
        url_text='/admins/getemailtemplatesbyajax/'+projectid+'/'+selectedid+'/'+extra
       else
        url_text='/admins/getemailtemplatesbyajax/'+projectid+'/'+selectedid;
