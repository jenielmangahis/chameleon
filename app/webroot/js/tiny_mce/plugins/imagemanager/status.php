...
<fieldset style="width: auto;">
	...
	<table border="1" cellspacing="0" cellpadding="3">
		...
		<tr>
			<td class="tdtitle">Value</td>
			<td><?= $exif ? "True" : "False"; ?></td>
		</tr>
		<tr>
			<td class="tdtitle">Status</td>
			<?= (!$exif_exists) ? "<td>Can not use exif to extract thumbnails from Jpeg files, this is not a fatal error.</td>" : "<td>OK</td>"; ?>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			<td class="tdtitle">Value</td>
			<td><?= $gd_enabled ? "True" : "False"; ?></td>
		</tr>
		<tr>
			<td class="tdtitle">GD Exists</td>
			<td><?= $gd_exists ? "True" : "False (Was not able to find all functions needed by the MCImageManager)"; ?></td>
		</tr>
		<tr>
			<td class="tdtitle">GD Version</td>
			<td><?= $gd_version; ?> (2.0 or higher required)</td>
		</tr>
		<tr>
			<td class="tdtitle">GD GIF Support</td>
			<td><?= $gd_gif ? "True" : "False"; ?> (required)</td>
			
		</tr>
		<tr>
			<td class="tdtitle">Status</td>
			<?= (!gdCheck()) ? "<td>Unable to use GD, check your php.ini file if it is enabled.<br/>You might have the wrong version, try upgrading PHP.</td>" : "<td>OK</td>"; ?>
		</tr>
	</table>
