	...
	class TCPDF {
		...
		public function getPageSizeFromFormat($format) {
			...
			switch (strtoupper($format)) {
				...
				case '123456' : {$pf = array( 215.899, 279.4); break;}	
				case '898988' : {$pf = array( 215.899, 139.7); break;}	
				case '898955' : {$pf = array( 107.949, 139.7); break;}
				case '365265' : {$pf = array( 101.6, 60.959); break;}	
				case '899845' : {$pf = array( 101.6,17.018); break;}	
				...
				case 'LETTERHALF' : {$pf = array(  612.000,  396.000); break;}
				case 'USLEGAL':
