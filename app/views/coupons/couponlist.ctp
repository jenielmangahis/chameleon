...
<script type="text/javascript">
    ...
    function activatecontents(act,op)
    {
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrl+"/coupons/changestatus/"+id+"/Coupon/1/couponlist/cngstatus";
                }else{
                    window.location=baseUrl+"/coupons/changestatus/"+id+"/Coupon/0/couponlist/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"/coupons/changestatus/"+id+"/Coupon/0/couponlist/delete";
            }
        }else{
   		...
   		<div class="slider-centerpage clearfix">
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                	<?php echo $form->create("coupons", array("action" => "couponlist",'name' => 'couponlist', 'id' => "couponlist")) ?>
					<script type='text/javascript'>
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            <?php echo $form->create("Coupon", array("action" => "couponlist",'name' => 'couponlist', 'id' => "couponlist")) ?>
            <script type='text/javascript'>
                function setprojectid(projectid){
                    document.getElementById('projectid').value= projectid;
                    document.adminhome.submit();
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url ?>/coupons/couponlist')" id="locaa"></span>
