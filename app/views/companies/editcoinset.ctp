    ...
    <div style="width:960px; margin:0 auto;">
        ...
        <div align="center" id="toppanel" >
            <?php  echo $this->renderElement('new_slider');  ?>
                ...
                <?php echo $form->create("Company", array("action" => "editcoinset/".$recid,'type' => 'file','name' => 'editcoinset_order', 'id' => "editcoinset_order"))?>
...
*/?>
    ...
    <div class="frmbox mgrt115">
        ...
        <table cellspacing="5" cellpadding="0" align="center" align="center" width="500px" class="left" style="margin-top: 30px; margin-bottom: 30px; margin-left: 35px;">
            ...
            <tr>
                <td width="5" valign="top" style="padding-top: 4px;"> <?php echo $form->input("Coinset.check_qr", array('id' => 'check_qr', 'div' => false, 'label' => '','type'=>'checkbox','disabled'=>'disabled','checked'=>$check_qr));?></td>
                <td width="130" valign="top" style="padding-top: 4px;" >QR Per Unit</td>
                <td width="30"><span class="intpSpan"><?php echo $form->input("Pricing.setup_qr", array('id' => 'setup_qr', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "200",'style'=>'width:50px;text-align:right;','readonly'=>'readonly'));?></span></td>
...
*/?>
        ...
        <div class="table-footer" style="width: 530px;">
                ...
                <div class="right" style="width: 62px;float: left;padding-bottom: 10px;">
                    <div style="float:right; width: 110px; text-align: right;"> <!--<span>$</span>--><span id="totalperunit">0</span></div>
                </div>
                <?php echo $form->hidden("Coinset.total_per_unit", array('id' => 'total_perunit'));  ?> 
