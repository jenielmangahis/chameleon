...
<div >
<p>
	<img alt="" src="<?php echo $baseUrl.'img/'.$project_name ?>/box_top.png">

	<?php
		e(
			 
				$html->image('img',$project_name,'box_top.png'), 
				//array('action' => $href_coin_image), 
				array('escape' => false));
	?>
...
<div align="center" class="conConts" >
	...
	<!--<a href="<?php echo $href_coin_image; ?>" ><img  width="177" hieght="177"  src="img/<?php echo $dataprojects['Project']['project_name'].'/uploads/'.$coinsdetail['Coinset']['sidea']; ?>" alt="" /></a>-->
	<?php
		e(
			$html->link( 
				$html->image('img',$dataprojects['Project']['project_name'],'uploads',"add.gif",$coinsdetail['Coinset']['sidea']), 
				array('action' => $href_coin_image), 
				array('escape' => false)));
	?>
	<br /><br />
	<a href="<?php echo $href_coin_image; ?>" ><img  width="177" hieght="177"  src="img/<?php echo $dataprojects['Project']['project_name'].'/uploads/'.$coinsdetail['Coinset']['sideb']; ?>" alt="" /></a><br>
</div>
