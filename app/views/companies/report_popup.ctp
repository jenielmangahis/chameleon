...
<div><lable class='lbl'>Message:<span style="color:red">*</span></lable> 
<?php echo $form->textarea("comments12", array('id' => 'comments12', 'div' => false, 'label' => '','cols' => '50', 'rows' => '4', 'class'=>'top','style'=>'border:1px solid #BEDAE5;'));?>
</div>
