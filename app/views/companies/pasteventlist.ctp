<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrl+"companies/changestatus/"+id+"/Event/1/pasteventlist/cngstatus";
                }else{
                    window.location=baseUrl+"companies/changestatus/"+id+"/Event/0/pasteventlist/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"companies/changestatus/"+id+"/RecurringEvent/0/pasteventlist/delete";
            }
        }else{
...
<div align="center" class="slider" id="toppanel">
     <?php  echo $this->renderElement('new_slider');  ?>
               ...
               <?php echo $form->create("Company", array("action" => "pasteventlist",'name' => 'eventlist', 'id' => "eventlist")) ?>
            <script type='text/javascript'>
...
<ul class="topTabs2">
				  ...
				  <?php	$this->loginarea="companies";    $this->subtabsel="pasteventlist";
...
<div class="midCont">	       
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/pasteventlist')" id="locaa"></span>
 ...
 <tr class="trBg">
                ...
                <th align="center" valign="middle" width="12%"> <span class="right"><?php echo $pagination->sortBy('location', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');  ?></span>Location</th>
                ...
                <th align="center" valign="middle" width="8%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');  ?></span>Member</th>
                ...
                <!--<th align="center" valign="middle" width="70px"><span class="right"><?php // echo $pagination->sortBy('active_status', '<img src="/img/sorting_arow.png" width="10" height="13" alt="" />',null,null,' ',' '); ?></span>Status</th>-->
                    ...
                    foreach($eventdata as $eachrow){
                        ...
                        //$endtime = $eachrow['RecurringEvent']['endtime'];
                        ...
                        <td align="left" valign="middle">
							<?php
								e($html->link(
									...
									array('controller'=>'companies','action'=>'pasteventcreated',$recid),
									array('escape' => false)
									)
								);
							?>
