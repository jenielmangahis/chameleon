    ...
    $('.checkid').each(function(){       
        ...
        {           
			...
			if(id !=""){
					if(op=="change"){	
						if(act=="active"){
							window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/1/eventautoresponders/cngstatus";
							}else{
							window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/0/eventautoresponders/cngstatus";
							}
					}
					if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
					window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/0/eventautoresponders/delete";
					}
			}else{
...
<div align="center" class="slider" id="toppanel">
	 <?php  echo $this->renderElement('new_slider');  ?>
        ...
        <?php echo $form->create("Company", array("action" => "eventautoresponders",'type' => 'file','enctype'=>'multipart/form-data','name' => 'contentlist', 'id' => "mailautoresponderlist"))?>
        <script type='text/javascript'>
...
<li>
	<?php
		e($html->link(
			$html->tag('span', 'New'),
			array('controller'=>'companies','action'=>'addmailtemplate','event'),
			array('escape' => false)
			)
		);
?>
...
<ul class="topTabs2">
				<!--<li><a href="/companies/eventlist" ><span>Current Events</span></a></li>    
                  ...
                  <li><a href="/companies/eventautoresponders" class="tabSelt"><span>AutoResponse</span></a></li>    
			...
			<?php
					$this->loginarea="companies";    $this->subtabsel="eventautoresponders";
...
<!--inner-container starts here-->
  ...
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
		...
		<span class="srchBg2">
				<input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/eventautoresponders')" id="locaa">
		</span>
	...
	<tr>    
                ...
                <td align="center" valign="middle">
					<?php if($eachrow['EmailTemplate']['active_status']=='1'){ 
						...
						e($html->link(
								$html->image('deactive.gif',array('width'=>'10','height'=>'13','alt'=>'','title'=>'Click here to activate '.$tempname)),
								array('controller'=>'companies5/14/2012','action'=>'changestatus',$recid,$modelname,'1',$redirectionurl,'cngstatus'),
								array('escape' => false)
								)
							);
				}
