...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrl+"companies/changestatus/"+id+"/Holder/1/memberlist/cngstatus";
                }else{
                    window.location=baseUrl+"companies/changestatus/"+id+"/Holder/0/memberlist/cngstatus";
				}
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"companies/changestatus/"+id+"/Holder/0/memberlist/delete";
            }
        }else{
...
<div class="container">
       <div class="titlCont"><div style="width:960px; margin:0 auto;">
            ...
            <?php echo $form->create("Companies", array("action" => "memberlist",'name' => 'memberlist', 'id' => "memberlist")) ?>
            ...
            <div class="topTabs">
                <ul class="dropdown">
						...
						<?php
							e($html->link(
										$html->tag('span', 'New'),
										array('controller'=>'companies','action'=>'addholder'),
										array('escape' => false)
										)
							);
						?>
             ...
             <?php  $this->loginarea="companies";    $this->subtabsel="memberlist";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/memberlist')" id="locaa">&nbsp;&nbsp;  
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" style="width:12%"><span class="right"><?php echo $pagination->sortBy('firstname', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>First Name</th>
                ...
                <th align="center" valign="middle" style="width:16%"><span class="right"><?php echo $pagination->sortBy('donation_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Donation Level</th>
            ...
            <?php if($memberlist){
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="10" align="center">No member(s) found.</td></tr>
                <?php  } ?>
