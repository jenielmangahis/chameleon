...
{   
	...
	{	
		...
		if(counter!=1)
		{
			...
			document.getElementById("linkedit").href=baseUrl+"companies/editmailcontent/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
			...
			if(id !=""){
					if(op=="change"){	
						if(act=="active"){
							window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/1/mailtemplatelist/cngstatus";
							}else{
							window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/0/mailtemplatelist/cngstatus";
							}
					}
					if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
					window.location=baseUrl+"companies/changestatus/"+id+"/EmailTemplate/0/mailtemplatelist/delete";
					}
			}else{
...
<li>
	...
	e($html->link(
		$html->tag('span', 'New'),
		array('controller'=>'companies','action'=>'addmailtemplate'),
		array('escape' => false)
		)
	);
?>
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li>
   ...
   <?php    $this->loginarea="companies";    $this->subtabsel="mailtemplatelist";
...
<!--inner-container starts here-->
  ...
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
		...
		<span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/mailtemplatelist')" id="locaa"></span>
   ...
   <th align="center" valign="middle" style="width:21%"><span class="right"><?php echo $pagination->sortBy('email_template_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Template Name</th>
   <th align="center" valign="middle" style="width:21%"><span class="right"><?php echo $pagination->sortBy('subject', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Subject</th>
   <th align="center" valign="middle" style="width:20%">Mail Content</th>
   ...
   <tr class='altrow'>    
                ...
                <td align="center" valign="middle"  class='newtblbrd' >
					<a href='editmailcontent/<?php echo $recid ;?>'><span><?php echo $cont1; ?></a></span>
					<?php
						e($html->link(
							$html->tag('span', $cont1),
							array('controller'=>'companies','action'=>'editmailcontent','edit',$recid),
