	...
	<div class="titlCont">
    	<div class="slider-centerpage clearfix">
        	<div class="center-Page col-sm-6">
            	<h2><?php echo ucfirst($option); ?> Branch List</h2>
            </div>
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                    ...
                    <?php
                    e($html->link($html->image('new.png', array('alt' => 'New')) . ' ',array('controller'=>'players','action'=>'adddetail',$option,'branch'),array('escape' => false)));?>
