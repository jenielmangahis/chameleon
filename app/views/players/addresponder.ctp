                            ...
                            <tbody>
                                ...
                                <?php if($isreadonly=='1'){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"><span class="intpSpan"><?php echo $form->input("EmailTemplate.email_template_name.", array('id' => 'email_template_name', 'div' => false, 'label' => '','style' =>'width:400px;',"class" => "inpt_txt_fld","maxlength" => "250",'readonly'=>false));?></span></td>
                                    </tr>
                                    <?php } ?>
				...
				echo $form->select("EmailTemplate.relationship_type", $common->getRelationshipTypeForResponder(0,'drp'), $relationshiptype, array('id' => 'relationship_type','class'=>'multilist'),"---Select---");?>
                                ...
                                <tr>
                                    ...
                                    <td  ><?php echo $form->hidden("EmailTemplate.id", array('id' => 'templateid'));    ?>
                                        ...
                                        <?php }else { ?>
                                        	<?php echo $form->input("EmailTemplate.subject", array('id' => 'subject', 'div' => false, 'label' => '','style' =>'width:400px;',"class" => "inpt_txt_fld","maxlength" => "250", "value"=>str_replace("[[PROJECT_NAME]]", $current_project_name,  "[[PROJECT_NAME]]"), 'readonly'=>false  ));?>
                                        <?php } ?>   
                                        </span>
                                    </td>    
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td ><span class="intpSpan">
                                    	...
                                    	<?php } else { ?>
                                    		<?php echo $form->input("EmailTemplate.sender", array('id' => 'sender', 'div' => false, 'label' => '','style' =>'width:400px;',"class" => "inpt_txt_fld","maxlength" => "250", "value"=> str_replace("[[Project Website Address]]", $current_project_name.'.com',  "info@[[Project Website Address]]") ,'readonly'=>false ));?>
                                            <?php } ?>
                                        </span>
                                    </td>
                                </tr>
