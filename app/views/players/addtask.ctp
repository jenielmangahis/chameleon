	...
	<div id="addcmp" class="midCont clearfix">
		...
		<div class="clearfix">
			...
			echo $form->select("CommunicationTask.email_template_id",$templatedropdown,$sel_email_temp,array('id' => 'email_template_id','class'=>'multi-list form-control','onchange'=>'getEmailTemplate(this.value)'),array('0'=>'--Select--')); ?>
										...
										</span> <span class="btn-Lft"><input type="button"
												class="btn-Rht btn btn-primary btn-sm" value="Add" name="Add"
									...
									<tr>
										...
										<td><input type="hidden" name="is_memberdisabled"
											...
											class="txtArea-top"> <span class="txtArea-bot"> <?php echo $form->select("CommunicationTask.company_type",$companytypedropdown,$sel_companytypeid,array('id' => 'companytypeid','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <?php echo $form->select("CommunicationTask.category_id",$categorydropdown,$sel_category,array('id' => 'category_id','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
			...
			$('#category_id').live('change', function(){
				$('#sub_category_id').load(baseUrl+'players/ajax_get_sub_category/'+$(this).val());
		...
		</script> <span class="txtArea-top"> <span class="txtArea-bot"> <?php $selectedsubcategory; echo $form->select("CommunicationTask.sub_category_id",$subcategorydropdown,$sel_sub_category,array('id' => 'sub_category_id','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <?php echo $form->select("CommunicationTask.non_profit_type_id",$nonprofittypedropdown,$sel_nonprofittype,array('id' => 'non_profit_type_id','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <?php echo $form->select("CommunicationTask.contact_type",$contacttypedropdown,$sel_contactypeid,array('id' => 'contactypeid','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <?php echo $form->select("CommunicationTask.offer_id",$offertypedropdown,$sel_offer,array('id' => 'offer_id','class'=>'multi-list form-control'),"---Select---"); ?>
											</span>
										</span></td>
									</tr>
										...
										<td>
											<div id="div_days_ago">
												<label class="boldlabel"> &nbsp;&nbsp;&nbsp; Days Ago :</label><span
													class="intp-Span" style="vertical-align: top"> <?php echo $form->input("CommunicationTask.member_noof_days_since", array('id' => 'member_noof_days_since', 'div' => false, 'label' => '','style' =>'width:125px;',"class" => "inpt-txt-fld form-control","maxlength" => "250"));?>
												</span>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="newtxtArea-bot"> <?php echo $form->select("CommunicationTask.member_country",$countrydropdown,$sel_country,array('id' => 'country','class'=>'multi-list form-control','onchange'=>'return getstateoptions(this.value,"Company")'),array('254'=>'United States')); ?>
											</span>
										</span></td>
									</tr>
									<tr>
...
?>
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <span
													id="statediv"> <?php echo $form->select("CommunicationTask.event_id",$eventdropdown,$sel_event,array('id' => 'event_id','class'=>'multi-list form-control'),"---Select---"); ?>
												</span>
											</span>
										</span></td>
									</tr>
									...
									<tr>
										<td align="right" width="140px"><label class="boldlabel">Recur
												Pattern</label></td>
										<td><span class="txtArea-top"> <span class="txtArea-bot"> <span
													id="countrydiv"> <?php echo $form->select("CommunicationTask.recur_pattern",$recur_pattern,$sel_recur_pattern,array('id' => 'recur_pattern',"class"=>"multi-list form-control"),false); ?>
														<script type="text/javascript">
		   ...
		   echo $form->text("CommunicationTask.task_startdate", array('id' => 'task_startdate', 'div' => false, 'label' => '',"class"=>"inpt-txt-fld form-control","maxlength" => "200","style" => "width:200px", 'value'=>$task_startdate,'readonly'=>'readonly'));?>
			  ...
			  $taskEndafterOccrrences=1;
									...
									<tr>
										...
										<td><span class="txtArea-top"> <span class="txtArea-bot"><?php echo $form->input("CommunicationTask.task_note", array('id' => 'task_note', 'div' => false, 'label' => '','rows'=>'8','cols'=>'36','class' =>'noBg'));?>
											</span>
										</span></td>
									</tr>
									<tr>
