...
<div style="width:960px; margin:0 auto;">
	<div align="center" class="slider" id="toppanel" style="height: 20px; top:13px;right: -50px;width:545px !important; text-align:right;">	<?php echo $form->create("players", array("action" => "addcontacts",'type' => 'file','enctype'=>'multipart/form-data','name' => 'addcontacts', 'id' => "addcontacts","onsubmit"=>"return validatecontacts('$act');"))?>
