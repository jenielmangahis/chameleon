...
<tr>
  ...
  <tr>
			...
			<div>
				...
				<div  style="margin-top:7px;"><span class="btn-Lft"><input type="button" value="View" tabindex=14 id="view_contact" class="btn-Rht btn btn-primary btn-sm" name="view" onclick="viewEmailTempforRSVP();"  /></span>
...
echo (!empty($prospectnonprofitid) && in_array($prospectnonprofit['Company']['id'],$prospectnonprofitid))?'checked="checked"' :'';											
			   ...
			   <tr>
					...
					<td>
						<span class="btn-Lft">
							 <input type="button" class="btn-Rht btn btn-primary btn-sm" value="Add" name="Addpnp" id="Addpnp" />  
                        </span>
