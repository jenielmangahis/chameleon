	...
	<div class="titlCont">
    	<div class="slider-centerpage clearfix">
        	<div class="center-Page col-sm-6">
            	<h2><?php echo ucfirst($str_type) ?></h2>
            </div>
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                    ...
                    <?php
                    e($html->link($html->image('new.png', array('alt' => 'New')) . ' ',array('controller'=>'prospects','action'=>'addprospect',$title_Val),array('escape' => false)));
			...
			<?php }else{ ?> <span class="titlTxt"><?php echo ucfirst($str_type) ?></span><?php } ?><?php */?>
...
<div class="clearfix nav-submenu-container">
	<div class="midCont submenu-Cont">
		<?php
            ...
            echo $this->renderElement('prospect_inner_submenu_vender');  
        ?>     
    </div>
</div>
