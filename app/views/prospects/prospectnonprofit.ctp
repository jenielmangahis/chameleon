    	...
    	<div class="slider-centerpage clearfix">
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                    ...
                    <?php
                    e($html->link($html->image('new.png', array('alt' => 'New')) . ' ',array('controller'=>'prospects','action'=>'addprospectnonprofit'),array('escape' => false)));
            ...
            <?php }else{ echo '<span class="titlTxt">Prospect Non Profit List</span>';}?><?php */?>            
        ...
        <div class="tblData table-responsive">
            <table class="table table-bordered table-striped" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="trBg">
					...
					<span class="right"></span>Non-Profit Type</th>	
