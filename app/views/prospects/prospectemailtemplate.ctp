  ...
  function editmailcontent()
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"prospects/addprospectmailtmp/"+id+""; 
        }
    }
...
<div class="titlCont"><div class="centerPage">
       ...
       <div class="slider" id="toppanel" style="height: 20px; top:13px;right: -50px;width:545px !important; text-align:right;">
				...
				<?php e($html->link($html->image('new.png') . ' ' . __(''), array('controller'=>'prospects','action'=>'addprospectmailtmp'),array('escape' => false)));
