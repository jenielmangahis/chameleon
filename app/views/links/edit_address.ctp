...
<?php echo $form->create("links", array("action" => $editLink,'name' => 'LinkAddress', 'id' => "LinkAddress", 'class' => 'adduser'));
 ?>
...
<span class="titlTxt">Edit Address</span>
