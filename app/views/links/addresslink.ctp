    ...
    $('.checkid').each(function(){       
        ...
        {           
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location="../links/addresslink_delete/"+id ;
                                        }
                        }else{
...
<?php
e($html->link($html->image('new.png', array('alt' => 'New')) . ' ',	array('controller'=>'links','action'=>'add_address'),array('escape' => false)));
?>
...
<span class="titlTxt"> Addresses List </span>
...
<?php
	e($html->link(
		$html->tag('span', 'New'),
		array('controller'=>'links','action'=>'add_address'),
		array('escape' => false)
		)
	);
?>
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li>
            ...
            <?php    $this->loginarea="links";    $this->subtabsel="addresslink";
...
<div id="blck"> 
        <div class="msgBoxTopLft"><div class="msgBoxTopRht"><div class="msgBoxTopBg"></div></div></div>
	        <div class="msgBoxBg">
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'links/addresslink')" id="locaa"></span>
        ...
        <th align="center" valign="middle" style="width:13%;"><span class="right"><?php echo $pagination->sortBy('description', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Discription</th>
        ...
        <?php
                if($taskdata){
                        ...
                        $recid = $eachrow['LinkAddress']['id'];
                        $modelname = "LinkAddress";
                        $redirectionurl = "commtasklist";
                        $company_task_id = $eachrow['LinkAddress']['id'];
						$link_address = $eachrow['LinkAddress']['link_address'];
						$description = $eachrow['LinkAddress']['description'];
                ?>
	...
	<?php if($i%2 == 0) { ?>
        ...
        <tr class='altrow'>    
				...
				<?php e($html->link($html->tag('span', $link_address),array('controller'=>'links','action'=>'edit_address',$recid),array('escape' => false))); ?>
				</td>
				              
                <td align="left" valign="middle" class='newtblbrd'>
					<?php e($html->link($html->tag('span', $description),array('controller'=>'links','action'=>'edit_address',$recid),array('escape' => false))); ?>
				</td>              
              
                 <td align="center" valign="middle" align="center" class='newtblbrd'>
					<?php if($eachrow['LinkAddress']['status'] === 'a'){ e($html->link($html->tag('span', 'Active'),array('controller'=>'links','action'=>'edit_address',$recid),array('escape' => false))); } else{ 
					
					e($html->link($html->tag('span', 'Active'),array('controller'=>'links','action'=>'edit_address',$recid),array('escape' => false)));
					}?>
