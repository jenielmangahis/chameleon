	...
	<div class="titlCont">
    	<div class="slider-centerpage clearfix">
            ...
            <div class="slider-dashboard col-sm-9">
            	<div class="icon-big-container">
                	<?php echo $form->create("relationships", array("action" => "los",'name' => 'los', 'id' => "los"))?>
					<?php
                    ...
                    e($html->link($html->image('new.png') . ' ', array('controller'=>'contacts','action'=>'addlos'),array('escape' => false))); ?>
            ...
            <span class="titlTxt">Lo's List</span>-->
        ...
        <?php /*?><ul class="dropdown">
          ...
          <?php
            e($html->link(
            $html->tag('span', 'New'),
            array('controller'=>'contacts','action'=>'addlos'),
            array('escape' => false)
            )
            );
          ?>
...
<div class="clearfix nav-submenu-container">
	<div class="midCont submenu-Cont">
		<?php    $this->loginarea="relationships";    $this->subtabsel="los";
...
<div class="midCont" id="newcnttab">
  ...
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
    ...
    <span class="topRht_curv"></span>-->             
        <div class="gryTop">
                <?php echo $form->create("contacts", array("action" => "los",'name' => 'contactlist1', 'id' => "contactlist1")) ?>
                <script type='text/javascript'>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'relationships/los')" id="locaa"></span>
                </div>
   ...
   <td align="left" class='newtblbrd' valign="middle">
      ...
      <?php
        e($html->link(
          ...
          array('controller'=>'contacts','action'=>'editlos',$recid,$companyID),
          array('escape' => false)
          )
        );
      ?>
...
<?php } ?>  
  ...
  <?php } }else{ ?>
  <tr><td colspan="7" align="center">No LO's Found.</td></tr>
  <?php } ?>
  </table>
  </div>
...
{   
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"contacts/editlos/"+id; 
