...
<?php $pagination->setPaging($paging); ?>
	<div class="titlCont">
		<div class="slider-centerpage clearfix">
            ...
            <span class="titlTxt">Employees List</span>-->
...
<div class="midCont" id="newcnttab">
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
    ...
    <span class="topRht_curv"></span>-->             
        <div class="gryTop">
                <?php echo $form->create("contacts", array("action" => "employees",'name' => 'contactlist1', 'id' => "contactlist1")) ?>
                <script type='text/javascript'>
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'relationships/employees')" id="locaa"></span>
                </div>
...
<?php } ?>  
  ...
  <?php } }else{ ?>
  <tr><td colspan="7" align="center">No Employee Found.</td></tr>
  <?php } ?>
  </table>
