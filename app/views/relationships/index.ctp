    ...
    $('.checkid').each(function(){          
     ...
     if(counter!=1)
     {
               alert("please select only one row  to edit");
                ...
                document.getElementById("linkedit").href=baseUrl+"relationships/editlink/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location="../relationships/activelink_delete/"+id ;
                                        }
                        }else{
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li>
            ...
            <?php    $this->loginarea="relationships";    $this->subtabsel="index";
...
<div id="blck"> 
        <div class="msgBoxTopLft"><div class="msgBoxTopRht"><div class="msgBoxTopBg"></div></div></div>
	        <div class="msgBoxBg">
				...
				<span class="srchBg"><?php echo $form->input("searchkey", array('id' => 'searchkey', 'div' => false, 'label' => '',"maxlength" => "200"));?></span><span class="srchBg2"><?php echo $form->submit("Go", array('id' => 'searchkeysubmit', 'div' => false, 'label' => '','class'=>'btn'));
                        ?> 
                </span>
				
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'links/activelinklist')" id="locaa"></span>
