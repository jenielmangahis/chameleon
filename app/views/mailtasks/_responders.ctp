...
<div class="titlCont1"><div class="myclass">
        ...
        echo $form->create("mailtask", array("action" => "responder".$action ,'name' => 'responder', 'id' => "responder","onsubmit" =>"return validatemailcontent('edit');"));
        ?>
            <?php if(isset($respondertype)){ echo $form->hidden("respndertype", array('id' => 'respndertype', 'value'=>$respondertype)); }
            ...
            if($this->data['EmailTemplate']['is_event_temp']==3)
                $invite="Checked='yes'";
             ?> 
			  <?php echo $form->hidden("EmailTemplate.respnder_type", array('id' => 'respnder_type', 'value'=>$respondertype));  ?>
