...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"mailtasks/editcommtask/"+id; 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/CommunicationTaskHistory/1/taskhistorylist/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/CommunicationTaskHistory/0/taskhistorylist/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"mailtasks/changestatus/"+id+"/CommunicationTaskHistory/0/taskhistorylist/delete";
                                        }
                        }else{
	...
	<div class="titlCont">
		<div class="slider-centerpage clearfix">
        	<div class="center-Page col-sm-6">
                <h2>Email Tasks History</h2>
            </div>
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                	<?php echo $form->create("mailtasks", array("action" => "taskhistorylist",'name' => 'taskhistorylist', 'id' => "taskhistorylist")) ?>
						<script type='text/javascript'>
...
<div class="clearfix nav-submenu-container">
	<div class="midCont submenu-Cont">
		 <?php    $this->loginarea="admins";    $this->subtabsel="taskhistorylist";
...
<div id="blck"> 
    ...
    z-index: 11;" /></a>
               ...
               <div class="new_filter" >
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url ?>mailtasks/taskhistorylist')" id="locaa"></span>
        ...
        <th align="center" valign="middle" style="width:18%;"><span class="right"><?php echo $pagination->sortBy('email_template_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'EmailTemplate',null,' ',' '); ?></span>Related Template</th>      
        ...
        <th align="center" valign="middle"style="width:8%;"><span class="right"><?php echo $pagination->sortBy('task_sent_count',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CommunicationTaskHistory',null,' ',' '); ?></span># Sent</th>      
