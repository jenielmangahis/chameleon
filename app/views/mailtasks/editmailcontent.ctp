...
<?php $lgrt = $session->read('newsortingby');
	...
	$backUrl = $base_url.'mailtasks/responderslist';
...
<div class="titlCont1"><div class="myclass">
        ...
        <?php echo $form->create("mailtasks", array("action" => "editmailcontent/edit/$templateid",'name' => 'editmailcontent', 'id' => "editmailcontent","onsubmit" =>"return validatemailcontent('edit');"));
 ?>
            ...
            if($this->data['EmailTemplate']['is_event_temp']==3)
                $invite="Checked='yes'";
             ?>
          <span class="titlTxt">Edit Responder Template
        </span>
        <div class="topTabs">
            <ul>
