...
$backUrl = $base_url.'mailtasks/activetask';
?>
<?php
...
<script type="text/javascript">
 ...
 echo $form->create("mailtasks", array("action" => "addtask",'name' => 'addtask', 'id' => "addtask",'onsubmit'=>'return validatecommtask();'));
 ...
 <span class="titlTxt"> Active Email Tasks </span>
            ...
            <?php    $this->loginarea="admins";    $this->subtabsel="activetask";
