...
<div class="titlCont"><div style="width:960px;margin:0 auto">
       <?php echo $form->create("Setups", array("action" => "addhelp/".$this->data['HelpContent']['id'],'name' => '', 'id' => "", 'class' => '', 'enctype' => "multipart/form-data",'onsubmit' => 'return validatepassword();'))?>
        <div align="center" id="toppanel" >
	        <?php  echo $this->renderElement('new_slider');  ?>
                
        </div>
        <span class="titlTxt">Add Help </span>
         <div class="topTabs">
                <ul>
             ...
             echo $form->error('Admin.Cpassword', 'Please confirm Password', array('class' => 'errormsg'));
                ...
                ?>                
				 <tr> 
                        ...
                        <td><?php echo $form->input("HelpContent.section", array( 'div' => false, 'options' => $optionSection, 'label' => '',  "class" => "inpt_txt_fld")); ?>
