...
<div class="topTabs">
<ul>
<li><button type="submit" name="redirectpage" id="Submit" class="button"><span> Save</span> </button>&nbsp;</li>
<!--li><button type="submit" name="samepage" id="saveForm" class="button"><span> Apply</span> </button></li-->
...
<div id="tab-container-1">
	<ul id="tab-container-1-nav" class="topTabs2">
        	<li onclick="settabinfo('0');"><a href="#Detail"><span>Details</span></a></li>
        	<li onclick="settabinfo('1');" class="<?php echo $activetab2; ?>"><a href="#Images"><span>Images</span></a></li>
		<li onclick="settabinfo('2');"><a href="#Tracking"><span>Tracking</span></a></li>
		<!-- li><a href="#Themes"><span>Themes</span></a></li-->
		<li onclick="settabinfo('3');"><a href="#ProjectType"><span>Controls</span></a></li>
		<li onclick="settabinfo('4');"><a href="#Sponsor"><span>Sponsor</span></a></li>
		<!--li onclick="settabinfo('5');"><a href="#Coinsetstab"><span>Coinsets</span></a></li>
		<li onclick="settabinfo('6');"><a href="#Companiestab"><span>Companies</span></a></li>
		<li  onclick="settabinfo('7');"><a href="#Contactstab"><span>Contacts</span></a></li-->
...
<span class="txtArea_bot">
      <?php echo $form->select('coinsetsdisplay',$coinsetsdisplay, null,array('multiple'=>'multiple','id'=>'emaillists','size'=>'7','empty'=>false,'disabled'=>'disabled','class'=>'multilist'));?></span></span></td> 
      </tr>
      <tr>
<td>&nbsp;</td>
...
<!--tr>
    ...
    <!--tr><td colspan='2'>
    			 <span class="btnLft"><button type="submit" id="Submit" class="btnRht"> Save </button>&nbsp;</span>
...
<table class='left' width="425px">
		        ...
		        <tr>
			       ...
			       <div >
			       <span class="txtArea_top" >
<span class="txtArea_bot"><?php echo $form->select('companies',$companies, null,array('multiple'=>'multiple','id'=>'companies','size'=>'7','empty'=>false,'disabled'=>'disabled','class'=>'multilist'));?></span></span>
			       </div>
			        <br />
		        ...
		        <tr>
		        	<td valign="top"><label class="boldlabel">Contacts:</label></td>
					      ...
					      <div >
					      <span class="txtArea_top">
<span class="txtArea_bot"><?php echo $form->select('contacts',$contacts, null,array('multiple'=>'multiple','id'=>'contacts','size'=>'10','empty'=>false,'disabled'=>'disabled','class'=>'multilist'));?></span></span>
					      </div>
					        <br />
...
<div class='clear'></div>
    ...
    <table width="800px" align="center" cellpadding="1" cellspacing="1">
									...
									<table class='left' width="361px">
										<tr>
											...
											<td>
												<div>
													<span class="txtArea_top">
													<span class="txtArea_bot"><?php echo $form->select('Sponsor.companies',$companies, null,array('multiple'=>'multiple','id'=>'companies','size'=>'7','empty'=>false,'class'=>'multilist'));?></span></span>
												</div>
										...
										<tr><td colspan='2'>&nbsp;</td></tr>
											...
											<td>
												<div >
													<span class="txtArea_top">
													<span class="txtArea_bot"><?php echo $form->select('Sponsor.contacts',$contacts, null,array('multiple'=>'multiple','id'=>'contacts','size'=>'10','empty'=>false,'class'=>'multilist'));?></span></span>
												</div>
												<?php if($spondtl['Sponsor']['id']==0) { ?>
													<br />
							...
							<tr>
								...
								<td width=""><label for="project_name"></label>
									<span class="txtArea_top">
													<span class="txtArea_bot"><?php echo $form->select("Sponsor.country",$countrydropdown,$selectedcountry,array('id' => 'country','class'=>"multilist",'onchange'=>'return getstates(this.value,"Sponsor")'),"---Select---"); ?></span></span></td>
							...
							<tr>
								...
								<td width=""><label for="project_name"></label>
									<span class="txtArea_top">
													<span class="txtArea_bot"><span id="statediv"><?php echo $form->select("Sponsor.state",$statedropdown,$selectedstate,array('id' => 'state','class'=>'multilist'),"---Select---"); ?></span></span></span></td>
...
<div class="clear"></div>
<div class="gryBot" style="width:100%">
<script type="text/javascript">
