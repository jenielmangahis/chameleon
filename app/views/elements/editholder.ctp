...
<link rel="stylesheet" type="text/css" href="/js/datetimepicker/timepicker_plug/css/style.css">
	...
	<?php 
		...
		echo $form->create("Companies", array("action" => "editholder/$recordid",'type' => 'file','enctype'=>'multipart/form-data','name' => 'editholder', 'id' => "editholder"));
...
<li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='/companies/holderslist')"><span> Cancel</span></button></li>
</ul>
</div>
</div>
...
<table class="left" width="300px">
				<tr>
				<td  valign='top'><label class="boldlabel">Coins:</label></td>
		       <td>
		       <div style="overflow:auto"><span class="txtArea_top">
<span class="txtArea_bot">
		       <?php echo $form->select('coinsetsdisplay',$selectedxcoinsholder, null,array('multiple'=>'multiple','id'=>'emaillists','size'=>'10','class'=>'multilist','empty'=>false,'disabled'=>'disabled'));?> </span></span>
		        </div>
		       </td>
		        </tr>
 ...
 <tr>
		         <td  valign='top'><label class="boldlabel">Comments:</label></td>
			      <td>
			      <div style="overflow:auto">
				<span class="txtArea_top">
<span class="txtArea_bot">
			     <?php 
				echo $form->select('commnetdatedisplay', $selectedxcomment, null,array('multiple'=>'multiple','id'=>'emaillists','class'=>'multilist','size'=>'10','empty'=>false,'disabled'=>'disabled'));?></span></span>
			        </div>
			      	</td>
		        </tr>
		         <tr><td colspan='2'>&nbsp;</td></tr>
