...
{   
	...
	if(counter!=1)
	{
		...
		document.getElementById("linkedit").href="/companies/actionreply/"+id; 
...
{	
	...
	if(id !=""){
			if(op=="change"){	
				if(act=="active"){
					window.location="/companies/changestatus/"+id+"/Subcomment/1/commentreplylist/cngstatus";
					}else{
					window.location="/companies/changestatus/"+id+"/Subcomment/0/commentreplylist/cngstatus";
					}
			}
			if(op=="del"){
			window.location="/companies/changestatus/"+id+"/Subcomment/0/commentreplylist/delete";
			}
	}else{
...
<li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Detail</span></a></li>
		...
		<span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='/companies/commentreplylist')" id="locaa"></span>
		<span class="spnFilt">
...
<?php $i=1; ?>	
	...
	<th align="center" width="3%">#</th>
	  ...
	  <th align="left" valign="middle"><span class="right"><?php echo $pagination->sortBy('serialnum', '<img src="/img/'.$project_name.'/sorting_arow.png" width="10" height="13" alt="" />',null,null,' ',' '); ?></span>Coin # </th>
	  <th align="left" valign="middle" style="width:10%">Reply </th>
	<th align="left" valign="middle" >Comment </th>
	  <th align="left" valign="middle" style="width:20%">Posted By</th>     
       <th align="left" valign="middle"><span class="right"><?php echo $pagination->sortBy('created', '<img src="/img/'.$project_name.'/sorting_arow.png" width="10" height="13" alt="" />',null,null,' ',' '); ?></span>Date</th>
       <th align="left" valign="middle"><span class="right"><?php echo $pagination->sortBy('active_status', '<img src="/img/'.$project_name.'/sorting_arow.png" width="10" height="13" alt="" />',null,null,' ',' '); ?></span>Verified Status</th>
        <th align="left" valign="middle" style="width:10%">Action</th>
   		...
   		<?php if($commentlist){
			...
			$repcomment = AppController::WordLimiter($repcomment,10);
   	...
   	<tr>	
		...
		<td align="left" valign="middle"><a><span><?php echo $repcomment?$repcomment:"N/A"; ?><a></span></td>
		...
		<td align="left" valign="middle"><a title="Click here to view detail of this comment"  href="/companies/actionreply/<?php echo $recid; ?>"> Detail </a></td>		
		</tr>		
	 <?php } }else{ ?>
