	...
	<tr>
		<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Company Type <span style="color: red;">*</span></label></td>
				...
				<span class="txtArea-top">
					...
					<?php echo $form->select("Company.company_type_id",$companytypedropdown,$selectedcompanytype,array('id' => 'company_type_id','class'=>'multil-ist form-control'),"---Select---"); ?>
		...
		<tr>
			...
			<td width="60%">
				<span class="txtArea-top">
					<span class="newtxtArea-bot">
						<?php echo $form->select("Category.category_id",$categorydropdown,$selectedcategory,array('id' => 'category_id','class'=>'multil-ist form-control','multiple'=>'multiple'),"---Select---"); ?>					</span>				</span>			</td>
		</tr>	
...
<tr>
				...
				<span class="txtArea-top">
					<span class="newtxtArea-bot">
				<?php echo $form->select("Company.country",$countrydropdown,$selectedcountry,array('id' => 'country','class'=>'multil-ist form-control','onchange'=>'return getstateoptions(this.value,"Company")'),array('254'=>'United States')); ?>				</span>				</span></td>
		    </tr>	
		     	...
		     	<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">State <span style="color: red;">*</span></label></td>
                            <td width="60%">
                                ...
                                <span class="txtArea_bot">
                                  <span id="statediv"> 
                <?php echo $form->select("Company.state",$statedropdown,$selectedstate,array('id' => 'state','class'=>'multil-ist form-control'),"---Select---"); ?></span>				</span>				</span></td>
		    </tr>    
...
<tr>
  ...
  <tr>
			...
			<div class="contactbox">
				<span class="txtArea-top">
					<span class="newtxtArea-bot">
						<?php echo $form->select("Contact.id",$contactdatadropdown,$companytocontact,array('id' => 'contact_id','class'=>'multil-ist form-control','multiple'=>'multiple','size'=>7)); ?>					</span>				</span>				</div>
						</td>
		</tr>	
