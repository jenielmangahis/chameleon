...
<table cellspacing="5" cellpadding="0">
  ...
  <tr>
			...
			<td width="60%">
			<span class="intpSpan"><?php echo $form->input("Company.company_name", array('id' => 'company_name', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "150","onsubmit"=>"return validatecompany('$act');"));?></span></td>
		</tr>
	...
	<tr>
		<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Company Type <span style="color: red;">*</span></label></td>
				...
				<span class="txtArea_top">
					...
					<?php echo $form->select("Company.company_type_id",$vendorcompanytype,$selectedcompanytype,array('id' => 'company_type_id','class'=>'multilist'),"---Select---"); ?>
