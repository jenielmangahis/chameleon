...
<table cellspacing="5" cellpadding="0" width="90%">
  ...
  <tr>
			...
			<td width="60%">
			<span class="intp-Span"><?php echo $form->input("Company.company_name", array('id' => 'company_name', 'div' => false, 'label' => '',"class" => "inpt-txt-fld form-control","maxlength" => "150","onsubmit"=>"return validatecompany('$act');"));?></span></td>
		</tr>
	...
	<tr>
		<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Company Type <span style="color: red;">*</span></label></td>
				...
				<span class="txtArea-top">
					...
					<?php echo $form->select("Company.company_type_id",$vendorcompanytype,$selectedcompanytype,array('id' => 'company_type_id','class'=>'multi-list form-control'),"---Select---"); ?>
...
<tr>
  ...
  <tr>
			...
			<div>
				...
				<span style="margin-top:7px;" class="btn-Lft"><input type="button" value="View" tabindex=14 id="view_contact" class="btn-Rht btn btn-primary btn-sm" name="view" onclick="viewEmailTempforRSVP();"  /></span>
				<span style="margin-top:7px;" class="btn-Lft"><input type="button" value="Add" name="Add" tabindex=15 class="btn-Rht btn btn-primary btn-sm" ONCLICK="addnewcontact()"/>
				</span>			</td>
		</tr>	
