...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/1/coinholderslist/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/coinholderslist/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/coinholderslist/delete";
            }
        }else{
...
<div class="container">
       <div class="titlCont"><div style="width:960px; margin:0 auto;">
            ...
            <?php echo $form->create("Admin", array("action" => "coinholderslist",'name' => 'coinholderslist', 'id' => "coinholderslist")) ?>
            <script type='text/javascript'>
            ...
            <span class="titlTxt">Members - Holding Coins  </span>
            ...
            <div class="topTabs">
             ...
             <?php    $this->loginarea="admins";    $this->subtabsel="coinholderslist";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">            
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrlAdmin+'coinholderslist')" id="locaa">&nbsp;&nbsp;  
            </span><span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="jjavascript:(window.location=baseUrlAdmin+'downloadholder')" > </span>
</div>
        </div>
    ...
    <div class="tblData">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('created', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				?></span>Register Date</th>
                <th align="center" valign="middle" style="width:12%"><span class="right"><?php echo $pagination->sortBy('firstname', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>First Name</th>
                <th align="center" valign="middle" style="width:12%"><span class="right"><?php echo $pagination->sortBy('lastnameshow', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>Last Name</th>
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('screenname',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');?></span>Screen Name</th>
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('member_type', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>Member Type</th>
                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('created', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>Serial Number</th>
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('created', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>Points</th>
                <th align="center" valign="middle" style="width:10%"><span class="right"><?php echo $pagination->sortBy('active_status ', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'Holder',null,' ',' ');
				 ?></span>Status</th>
            </tr>
            <?php $i=1;?>
            <?php if($holderlist){
					...
					for($k=0;$k<count($eachrow['CoinsHolder']);$k++){
						$ser[] = $eachrow['CoinsHolder'][$k]['serialnum'];
														
					}
						$serialNum = implode(',',$ser);				
                        $recid = $eachrow['Holder']['id'];
                        $userid = $eachrow['Holder']['user_id'];
                        $modelname = "Holder";
                        $othermodelname = "User";
                        $redirectionurl = "coinholderslist";
