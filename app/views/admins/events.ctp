...
<?php if(!$username)
{
    ...
    <span class="flx_button_lft ">
     <?php echo $form->button('Become a Member', array('div'=>false,"class"=>"flx_flexible_btn",'style'=>'font-size:12px;','onclick'=>"javascript:window.location='/companies/login'"));?> 
     </span>
    </div>
    <?php
}
                                    ...
                                    if(isset($eventdata)){
                                        ...
                                        if(sizeof($eventdata) > 0){
                                          foreach ($eventdata as $eachrow) { 
                                            ...
                                            {
                                                $match_found=0;
                                                $condition = "EventInvitation.project_id = '".$eachrow['RecurringEvent']['project_id']."' and  EventInvitation.event_id='".$eachrow['RecurringEvent']['event_id']."' and EventInvitation.active_status='1' and EventInvitation.delete_status='0' and EventInvitation.invite_to_holder_id='".$holder_id."'";
                                            ...
                                            <div class="blogarticle margin4px">
                                                <div class="blogtitle margin4px"><a href="/companies/events/0/<?php echo $eachrow['RecurringEvent']['id']; ?>" title="<?php echo $eachrow['RecurringEvent']['event_title'] ?>" id="blogtitle">  
                                                ...
                                                <div class="margin4px">
                                                    ...
                                                    <a href="/companies/events/0/<?php echo$eachrow['RecurringEvent']['id']; ?>" title="<?php echo $eachrow['RecurringEvent']['event_title']; ?>" class="orangeText" style="font-size: 11px;"> Read More</a>   </span>
                                                </div>
                                        ...
                                        $inquiry_details_page=AppController::getcontentsbyid($eventrow['RecurringEvent']['inquiry_detail_page']);
                                          ...
                                          ?>
                                        <div class="margin4px" style="float: left; position: relative; width: 900px; height: auto;font-size: 18px;"> 
                                            <div style="float: left; position: relative; width: 215px;"><b><?php echo $eventrow['RecurringEvent']['event_title']; ?></b></div>
                                            
                                            <div style="float: left; position: relative; margin-left: 10px;width: 315px;">Event Type:<?php echo $eventrow['RecurringEvent']['event_type']; ?> </div>
                                         ...
                                         <?php if($username)
                                            {
                                             ...
                                             <?php
                                                    ...
                                                    <div class="margin4px">
                                                    <b>Description:</b>
                                                        <?php echo  $event_data['Event']['eventdescription']; ?> 
                                                    </div>
                                        </div>                                        
...
<?php echo $form->button($head, array('div'=>false,"class"=>"flx_flexible_btn_red",'style'=>'font-size:12px;','onclick'=>"window.open('/companies/rsvp/".$eventrow['RecurringEvent']['id']."','windowname1','width=750, height=450,resizable=no,scrollbars=1'); return false;"));?> 
                                            ...
                                            ?>
                                             <div class="margin4px"><b>Member Price:</b>&nbsp;&nbsp;$<?php echo $member_price; ?> </div>
                                             <div class="margin4px"><b>Non-Member Price:</b>&nbsp;&nbsp;$<?php echo $non_member_price; ?> </div>

                                             <div class="margin4px"><b>Location:</b> <?php echo $eventrow['RecurringEvent']['location']; ?>  </div>
                                             <div class="margin4px"><b>Address:</b> <?php echo $eventrow['RecurringEvent']['address']; ?>  </div>
                                             <div class="margin4px"><b>Date:</b> <?php echo date("F j, Y", strtotime($eventrow['RecurringEvent']['start_date'])); ?> </div>
                                             <div class="margin4px"><b>Sart Time: </b><?php echo date("F j, Y ,", strtotime($eventrow['RecurringEvent']['start_date'])); ?> <?php echo date("g:i a", strtotime($eventrow['RecurringEvent']['starttime'])); ?></div>
                                             <!--<div class="margin4px"><b>End Time: &nbsp;</b><?php // echo date("F j, Y, g:i a", strtotime($eventrow['Event']['endtime'])); ?> <br /></div>-->
                                             
                                             <div class="margin4px"><b>Max. Attendees:</b> <?php echo $eventrow['RecurringEvent']['max_attendees']; ?> &nbsp;&nbsp;<b># Attending:</b> <?php echo $max_attendees_start; ?>  </div>  
                                             <div class="margin4px"><b>RSVP Required:</b>
                                             
                                              <?php if($eventrow['RecurringEvent']['rsvp_required']==1) echo"Yes"; else echo "No"; ?>  </div> 
                                        ...
                                        <?php 
                                        if($eventrow['RecurringEvent']['event_type']!="Conference Call" && $eventrow['RecurringEvent']['event_type']!="Webinar")
                                        {
                                            if($gmkey)
                                            {
                                                 echo $gm->GmapsKey(); 
