...
$backMemberList = $base_url_admin.'membersbylevel';
$backDownloadholder = $base_url_admin.'download_memberbylevel';
?> 
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/1/membersbylevel/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/membersbylevel/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Holder/0/membersbylevel/delete";
            }
        }else{
       ...
       <div class="slider-centerpage clearfix">
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container"> <!--<div align="center" class="slider" id="toppanel" style="height: 20px; top:13px;right: -50px;width:545px !important; text-align:right;">-->	
                	 <?php echo $form->create("Admin", array("action" => "membersbylevel",'name' => 'membersbylevel', 'id' => "membersbylevel")) ?><?php
            ...
            <!--<span class="titlTxt">Members By Member Level</span>-->
...
<div class="clearfix nav-submenu-container">
	<div class="midCont">
		<?php    $this->loginarea="admins";    $this->subtabsel="level";
        ...
        <table class="table table-striped table-bordered" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('member_type',$html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Member Type</th>
               <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('level_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Member Level</th>
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('points', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Points</th>
                <th align="center" valign="middle" style="width:7%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');
				 ?></span>Status</th>
            </tr>
            <?php $i=1;?>
            <?php if($memberlist){
                    ...
                    <tr class='<?php echo $cls; ?>'>    
							...
							<td align="left" valign="middle" class='newtblbrd'>
								<?php
									e($html->link(
										$html->tag('span', ($memberlevel)?$memberlevel:"N/A"),
										'#',
										array('escape' => false)
										)
									);			
