...
<tr> 
	<td align="right"><label class="boldlabel">User Type<span
			...
			echo $form->select("user_type",$formtypedata,$formtypedata,array('id' => 'user_type','class'=>'multilist'),array('0'=>'--Select--')); ?>
								</span>
							</span></td>
						</tr>
...
<tr>
		...
		<td>
			<span class="intpSpan">
					<?php echo $form->input("password", array('div' => false, 'label' => '','style' =>'width:200px;',"class"=>"inpt_txt_fld","maxlength" => "250"));?>
			</span>
		</td>	
	</tr>
