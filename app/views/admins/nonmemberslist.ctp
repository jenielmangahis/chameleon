    	...
    	<div class="slider-centerpage clearfix">
            ...
            <div class=" slider-dashboard col-sm-6">
            	<div class="icon-container">
                	 <?php
					e($html->link($html->image('new.png') . ' ',array('controller'=>'admins','action'=>'addnonmember'),array('escape' => false)));					
					?>
...
<div class="midCont">
    ...
    <div class="gryTop">
        <div class="new_filter">
                ...
                </span><span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="javascript:(window.location='<?php echo $downloadUrl ?>')" > </span>
            </div>
        </div>
        <div class="clear"></div>
