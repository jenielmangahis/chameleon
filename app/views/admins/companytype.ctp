...
<div class="topTabs">
		...
		<div class="clear"></div>
           <?php    $this->loginarea="admins";    $this->subtabsel="companytypes";
...
<div class="tblData">
		...
		<th align="center" valign="middle" style="width:2%"><input type="checkbox" id="checkall" name="checkall" value=""></th>
            <th align="center" valign="middle" style="width:20%"><span class="right"><?php echo $pagination->sortBy('company_type_category_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CompanyTypeCategory',null,' ',' '); ?></span>Company Type</th>
	       
			<th align="center" valign="middle" style="width:45%"><span class="right"><?php echo $pagination->sortBy('company_type_status_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),'CompanyTypeStatus',null,' ',' '); ?></span>Note</th>
