                                    ...
                                    <tr>
                                        <td width="25%" class="forName frmTitles" >Suggested Comment</td>
                                        <td width="75%" class="forName frmTitles">Comments & Replies</td>
                                    </tr>
                                    <?php if(sizeof($commentArray)==0){?> 
                                        <tr><td colspan="2" class="forName" align=center>No comment(s) posted coin by any member.</td></tr>
                                        <?php }else{    //DebugBreak();
                                            foreach($commentArray as $commentData){

                                            ?>
                                            <tr>
                                                <td  class="forName grayText" ><?php if($commentData['CommentType']['comment_type_name']=="") {
                                                     echo "Misc. Comment";
                                                }else{ 
                                               ...
                                               <?php   }?> 
                                                ...
                                                <?php echo $commentData['Comment']['comment'];  ?>  
                                                <?php }else {    ?>
                                                <a href="javascript:void(0);" id="editcomment_<?php echo $commentData['Comment']['id'];?>" title="Double click to Update comment"><?php echo $commentData['Comment']['comment'];  ?></a>
