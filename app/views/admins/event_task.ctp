	...
	<div class="titlCont" >
    	<div class="slider-centerpage clearfix">
        	<div class="center-Page col-sm-6">            	
                <h2>Event Mail Task Add/Edit</h2>
            </div>
...
<div class="midCont" id="sndmail">
    <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>          
        
         
    <div id="addcomm" class="event-task clearfix" style="border:none;">  
            ...
            <table cellspacing="5" cellpadding="0" align="left" width="100%">
                    <tbody> 
                            <tr>
                                ...
                                <td>
                                <span class="intp-Span"><?php echo $form->input("CommunicationTask.task_name", array('id' => 'task_name', 'div' => false, 'label' => '','style' =>'width:100%;',"class"=>"inpt-txt-fld form-control","maxlength" => "250"));?></span>
                                </td>
                            </tr>
                           ...
                           <tr>
                                ...
                                <td>
                                 <span class="txtArea-top">
                                    <span class="txtArea-bot">
                                      <span id="statediv"> 
                                <?php echo $form->select("CommunicationTask.rec_event_id",$eventdropdown,$sel_event_id,array('id' => 'event_id','class'=>'multi-list form-control'),"---Select---"); ?></span>
                                </span>
                                </span>  
                                </td>
                            </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                 <span class="txtArea-top">
                                    <span class="txtArea-bot">
                                      <span id="statediv"> 
                                <?php  echo $form->select("CommunicationTask.event_rsvp_type",$event_rsvp,$sel_event_rsvp,array('id' => 'event_rsvp_type','class'=>'multi-list form-control'),"---Select---"); ?></span>
                                </span>
                                </span>  
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                      <span class="txtArea-top">
                                      <span class="txtArea-bot">
                                        <?php echo $form->select("CommunicationTask.email_template_id",$templatedropdown,$sel_email_temp,array('id' => 'email_template_id','class'=>'multi-list form-control','onchange'=>'getEmailTemplate(this.value)'),array('0'=>'--Select--')); ?>
                                      </span>
                                      </span>
                                      <span class="btn-Lft"><input type="button"  class="btn-Rht btn btn-primary btn-sm" value="Add" name="Add" onclick="addEmailTempforTask();" /></span>
                               </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <span class="intp-Span" style="vertical-align: top"> 
                                        <?php echo $form->input("CommunicationTask.email_subject", array('id' => 'email_subject', 'div' => false, 'label' => '','style' =>'width:100%;',"class" => "inpt-txt-fld form-control","maxlength" => "250"));?>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><span class="intp-Span" style="vertical-align: top">
                                        <?php echo $form->input("CommunicationTask.email_from", array('id' => 'email_from', 'div' => false, 'label' => '','style' =>'width:100%;',"class" => "inpt-txt-fld form-control",'value'=>$fromemail));?>
                                </span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <span class="txtArea-top">
                                        <span class="txtArea-bot">
                                            <?php 
                                                echo $form->select("CommunicationTask.member_type",$member_types,$sel_member_types, array('id' => 'member_type', 'div' => false, 'label' => '','style' =>'background: none repeat scroll 0% 0% transparent; margin-bottom: 6px; width:100%;',"class" =>"form-control","maxlength" => "250"),"---Select---");
                                            ?>
                                        </span>
                                    </span>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <span class="intp-Span middle"><?php echo $form->text("CommunicationTask.member_agefrom", array('id' => 'member_agefrom', 'value'=>$agefrom, 'div' => false, 'label' => '',"class" => "inpt-txt-fld form-control","style" => "width:75px","maxlength" => "200",'readonly'=>'readonly'));?></span>&nbsp; to  &nbsp;
                                <span class="intp-Span middle"><?php echo $form->text("CommunicationTask.member_ageto", array('id' => 'member_ageto', 'value'=>$ageto, 'div' => false, 'label' => '',"class" => "inpt-txt-fld form-control","style" => "width:75px","maxlength" => "200",'readonly'=>'readonly'));?></span>
                                </td>
                            </tr>
                               ...
                               <tr>
                                ...
                                <span class="txtArea-top">
                                        <span class="txtArea-bot">
                                            <?php 
                                                echo $form->select("CommunicationTask.member_days_since",$days_since,$sel_days_since, array('id' => 'member_days_since', 'div' => false, 'label' => '','style' =>'background: none repeat scroll 0% 0% transparent; margin-bottom: 6px; width:100%;',"class" =>"form-control","maxlength" => "250"),"---Select---");
                                            ?>
                                        </span>
                                    </span>
                                 <div id="div_days_ago">
                              ...
                              <tr>
                                ...
                                <span class="txtArea-top">
                                    ...
                                    <?php echo $form->select("CommunicationTask.member_country",$countrydropdown,$sel_country,array('id' => 'country','class'=>'multi-list form-control','onchange'=>'return getstateoptions(this.value,"Company")')); ?>
                                </span>
                                </span>  
                                </td>
                            </tr>
                              <tr>
                                ...
                                <td>
                                 <span class="txtArea-top">
                                    <span class="txtArea-bot">
                                      <span id="statediv"> 
                                <?php echo $form->select("CommunicationTask.member_state",$statedropdown,$sel_state,array('id' => 'state','class'=>'multi-list form-control'),"---Select---"); ?></span>
                                </span>
                                </span>  
                                </td>
                            </tr>
                                ...
                                <table width="100%">
                                    <tbody>
                                            ...
                                            <td width="174px" align="right" >
                                             ...
                                             <td>
                                            <span class="intp-Span middle"><?php echo $form->text("CommunicationTask.member_zipcode_from", array('id' => 'member_zipcode_from',  'div' => false, 'label' => '',"class" => "inpt-txt-fld form-control","style" => "width:125px","maxlength" => "200",'value' => $member_zipcode_from));?></span>&nbsp; to  &nbsp;
                                            <span class="intp-Span middle"><?php echo $form->text("CommunicationTask.member_zipcode_to", array('id' => 'member_zipcode_to',  'div' => false, 'label' => '',"class" => "inpt-txt-fld form-control","style" => "width:125px","maxlength" => "200"));?></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <span class="txtArea-bot">
                                <span id="countrydiv">
                                    <?php echo $form->select("CommunicationTask.social_network_members",$social_networks,$sel_social_networks,array('id' => 'social_network_members',"class"=>"multi-list form-control"),array(''=>'--Select--')); ?></span></span></span>
                                  </td>
                            </tr>
                            ...
                            <span class="txtArea-bot">
                                <span id="countrydiv">
                                    <?php echo $form->select("CommunicationTask.non_network_members",$social_networks,$sel_non_networks,array('id' => 'non_network_members',"class"=>"multi-list form-control"),array(''=>'--Select--')); ?></span></span></span>&nbsp;&nbsp;
                                    </td>
                            </tr>
                        </tbody>
                     </table>
        ...
        <div class="frmbox2">
            <table cellspacing="10" cellpadding="0" align="center" width="100%">
                ...
                <span class="txtArea-bot">
                    <span id="countrydiv">
                        <?php echo $form->select("CommunicationTask.recur_pattern",$recur_pattern,$sel_recur_pattern,array('id' => 'recur_pattern',"class"=>"multi-list form-control"),false); ?></span></span></span>
                     </td>
                </tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                   <td align="right" width="140px"> <label class="boldlabel">Note</label></td>
                                    <td>
                                         <span class="txtArea-top">
                            <span class="txtArea-bot"><?php echo $form->input("CommunicationTask.task_note", array('id' => 'task_note', 'div' => false, 'label' => '','rows'=>'8','cols'=>'38','class' =>'form-control noBg'));?></span></span>
                                 </td>
                            </tr>
                              ...
                              <td>               
                               <span class="btn-Lft">   <button name="runreport" id="runreport" class="btn-Rht btn btn-primary btn-sm" value="RunReport" type="button"  >Run Report</button>  </span>
                                </td>
                            </tr>
