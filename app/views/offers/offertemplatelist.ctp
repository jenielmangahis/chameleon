...
$resetUrl = $base_url.'offers/offertemplatelist';
?>
<script type="text/javascript">
$(document).ready(function()
{
 ...
 function editmailcontent()
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"offers/addoffertemplate/"+id; 
	...
	<div class="slider-centerpage clearfix">
        ...
        <div class="slider-dashboard col-sm-6">
        	<div class="icon-container">
            	<?php echo $form->create("offers", array("action" => "offertemplatelist",'name' => 'offertemplatelist', 'id' => "offertemplatelist"))?>
				<?php
                e($html->link($html->image('new.png', array('alt' => 'New')) . ' ',array('controller'=>'offers','action'=>'addoffertemplate'),array('escape' => false)));
                ?>	
        ...
        <div class="topTabs" style="height:25px;">
            <?php /*?><ul class="dropdown">
				...
				e(
					$html->link(
						$html->tag('span','New'),
						array('controller'=>'offers','action'=>'addoffertemplate'),
						array('escape'=>false)
					)	
				);
				?>
...
<div class="clearfix nav-submenu-container">
	<div class="midCont submenu-Cont">
		<?php 
			$this->loginarea="offers";$this->subtabsel="offertemplatelist"; echo $this->renderElement('offer_email_submenus');  			
		?> 
    </div>
</div>
...
<div class="midCont">
    ...
    <th align="center" valign="middle" style="width:7%"><span class="right"><?php echo $pagination->sortBy('is_sytem', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
        ...
        <?php if($emailtemplates){
                        ...
                        $redirectionurl = "offertemplatelist";
                        $isdelflag = true;
        ...
        <tr <?php echo $class; ?> >
				...
				e($html->link(
					...
					array('controller'=>'offers','action'=>'addoffertemplate',$recid),
					array('escape' => false)
					)
				);
				?>
	...
	<?php }else{ ?>
	  ...
	  <?php
				e($html->link(
					...
					array('controller'=>'offers','action'=>'supermailtemplatelist'),
					array('escape' => false)
					)
				);
			?>	  
