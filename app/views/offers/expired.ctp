...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/1/expired/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/expired/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/expired/delete";
            }
        }else{
    	...
    	<div class="slider-centerpage clearfix">
            ...
            <div class="slider-dashboard col-sm-6">
            	<div class="icon-container">
                	<?php echo $form->create("Admin", array("action" => "expired",'name' => 'expired', 'id' => "expired")) ?>
					<script type='text/javascript'>
                ...
                <?php } ?>		   
                <span class="titlTxt"> Expired Offer  </span><?php */?>
...
<div class="clearfix nav-submenu-container">
	<div class="midCont submenu-Cont">
		<?php    $this->loginarea="offers";    $this->subtabsel="expired";
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>expired')" id="locaa"></span>
    ...
    <div class="tblData">
        ...
        <table class="table table-bordered table-striped" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('task_end_by_date', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Offer,null,' ',' ');?></span>Expired</th>
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Company,null,' ',' ');?></span>Merchant Name</th>
 ...
 <th align="center" valign="middle" width="6%"><span class="right"><?php echo $pagination->sortBy('controlled_by', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Controlled By</th>
            ...
            <?php if($offerdata){ 
                    ...
                    foreach($offerdata as $eachrow){
						...
						$expired = date('m/d/Y',strtotime($eachrow['Offer']['task_end_by_date']));
						?>
                    <tr <?php echo $class;?>>	
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="9" align="center">No Expire Offer Found.</td></tr>
                <?php } ?>
        </table> 
