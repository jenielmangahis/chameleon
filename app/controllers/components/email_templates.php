...
class EmailTemplatesComponent {
   ...
   const OPT_OUT_LINK_HTML ='<a href="[[OPT_OUT_URL]]"> Opt-Out</a> ';
   ...
   function initEmailTemplDataElemntsArray($projectId='', $projectDetails='', $toHolderEmailAddress='', $userType="Holder") {
         ...
         //define("DATA_ELEMENT_SENT_BY_EMAIL","SENT_BY_EMAIL");              //b Element   for sent by email address    
           ...
           define("DATA_ELEMENT_OPT_OUT_LINK","OPT_OUT_LINK");
        ...
        //   define("DATA_ELEMENT_EMAIL_UNSUBSCRIPTION_URL","EMAIL_UNSUBSCRIPTION_URL");      
           ...
           $this->dataElementArray=array(
                ...
                DATA_ELEMENT_OPT_OUT_LINK          =>  '[['.DATA_ELEMENT_OPT_OUT_LINK.']]' ,
        ...
        if($projectDetails!='' && $projectDetails!=null){  
            ...
            if(!empty($projectDetails['Project']['url'])) {
                             ...
                             if ($pos === false) {
                              ...
                              // Set DATA_ELEMENT_OPT_OUT_LINK  vlaue      OPT_OUT_LINK_HTML
                              $opt_out_url=$project_home_url."?optout=1";
                             $opt_out_link_html=str_replace("[[OPT_OUT_URL]]", $opt_out_url, EmailTemplatesComponent::OPT_OUT_LINK_HTML);
                             $this->dataElementValuesArray[DATA_ELEMENT_OPT_OUT_LINK]=$opt_out_link_html;
