	...
	*/
	...
	//	Configure::write('debug',2);
		...
		if(isset($this->data['Coupon']['searchkey']) && $this->data['Coupon']['searchkey']){
			 ...
			 $condition = "Coupon.project_id = '".$project_id."' AND Coupon.endtime >='".$current_date."' AND Coupon.delete_status ='0' AND CouponType.title LIKE '%".$searchkeyword."%' ";

		}else{

			 $condition = "Coupon.project_id = '".$project_id."' AND Coupon.endtime >='".$current_date."' AND Coupon.delete_status ='0'";
