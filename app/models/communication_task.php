...
return $days;
  ...
  function saveSendMailTask($sendMailTask, $projectid,$memberid,$rec_event_id=0){
       ##import Communication Task History  model for processing
					...
					$member_lavel = $sendMailTask['member_level']; 
                   ...
                   // $data['CommunicationTaskHistory'] =$taskArray;
					...
					$data['CommunicationTaskHistory']['memberid'] =$memberid; 
					$data['CommunicationTaskHistory']['member_level'] =$member_lavel;
                    ...
                    $data['CommunicationTaskHistory']['company_id'] = '0';
