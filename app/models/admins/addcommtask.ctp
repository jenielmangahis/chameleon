...
<script type="text/javascript">
    ...
    <?php echo $form->create("Admins", array("action" => "addcommtask",'name' => 'addcommtask', 'id' => "addcommtask",'onsubmit'=>'return validatecommtask();')); 
 ?>
...
<span class="titlTxt">Add Communication Task
</span>
...
<li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='/admins/commtasklist')"><span> Cancel</span></button></li>
</ul>
</div>
...
<div class='left' style="width:700px;">         
                <table cellspacing="10" cellpadding="0" align="center" width="800px">
                  <tbody>
                   ...
                   <tr>
                     <td  align="right"><label class="boldlabel" width="25%">Task Name <span class="red">*</span></label></td>
                    ...
                    <tr>
                     <td width="25%" align="right"> <label class="boldlabel">Select Email Template <span class="red">*</span></label></td>
                     <td width="70%"><span class="txtArea_top"><span class="txtArea_bot"><?php echo $form->select("CommunicationTask.email_template_id",$templatedropdown,0,array('id' => 'email_template_id',"style"=>"background: none repeat scroll 0% 0% transparent; margin-bottom: 6px; width: 230px;"),array('0'=>'--Select--')); ?></span></span>&nbsp;&nbsp;<span class="btnLft">
        <input type="button"  class="btnRht" value="Add" name="Add" ONCLICK="javascript:(window.location='/admins/addmailtemplate')" /></span></td>
                     ...
                     <td >
                                ...
                                <span class="txtArea_bot"><?php echo $form->input("CommunicationTask.notes", array('id' => 'notes', 'div' => false, 'label' => '','rows'=>'8','cols'=>'26','class' =>'noBg'));?></span></span></td>
                    </tr>
                    <tr>
