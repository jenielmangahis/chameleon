...
$backUrl = $base_url.'offers/offerresponderlist';
?>
<?php 

    echo $javascript->link('ckeditor/ckeditor'); 
    echo $form->create("offers", array("action" => "addofferresponder",'name' => 'addofferresponder', 'id' => "addofferresponder","onsubmit"=>"return validatemailcontent('add');")); 
...
<div class="titlCont1"><div class="myclass">
        ...
        <span class="titlTxt">Email Template Add/Edit
        </span>
