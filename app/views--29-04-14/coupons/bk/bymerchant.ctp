...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/1/bymerchant/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/bymerchant/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/bymerchant/delete";
            }
        }else{
...
<div class="container">
   ...
   <div class="myclass">
            ...
            <?php echo $form->create("Admin", array("action" => "bymerchant",'name' => 'bymerchant', 'id' => "bymerchant")) ?>
            <script type='text/javascript'>
...
<?php } ?>		   
            <span class="titlTxt"> Merchant Offer  </span>
          ...
          <?php    $this->loginarea="offers";    $this->subtabsel="bymerchant";
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>bymerchant')" id="locaa"></span>
    ...
    <div class="tblData">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Company,null,' ',' ');?></span>Merchant Name</th>
   ...
   <th align="center" valign="middle" width="8%"><span class="right"><?php echo $pagination->sortBy('offer_title', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Offer Name</th>
            ...
            <?php if($offerdata){ 
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="9" align="center">No Merchant Offer Found.</td></tr>
                <?php } ?>
        </table> 
