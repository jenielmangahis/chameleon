...
$backUrl = $base_url.'offers/offertemplatelist';
?>
<?php 

    echo $javascript->link('ckeditor/ckeditor'); 
    echo $form->create("offers", array("action" => "addoffertemplate",'name' => 'addoffertemplate', 'id' => "addoffertemplate","onsubmit"=>"return validatemailcontent('add');")); 
