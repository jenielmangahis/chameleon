...
$reset_url = $base_url."/offers/otherpages/".$paramsVal;
//echo $paramsVal;
?>
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onClick="javascript:(window.location='<?php echo $reset_url;?>')" id="locaa"></span>
    ...
    <div class="tblData">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" width="20%"><span class="right"><?php echo $pagination->sortBy('title', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Content,null,' ',' '); ?></span><?php echo ($extra=='all')?'Offer':ucfirst($paramsVal); ?> Page Name</th>
                <th width="150px"><a href="#"> </a><span class="right"><?php echo $pagination->sortBy('offer_title', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Offer Name</th>
                <th valign="middle" width="17%"><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Company,null,' ',' '); ?></span>Merchant</th>
                <th valign="middle" width="15%"><span class="right"><?php echo $pagination->sortBy('controlled_by', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Controlled By</th> 
                ...
                <th valign="middle" width="8%"><span class="right"><?php echo $pagination->sortBy('active_status', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
            </tr>
            <?php if($contentdata){ 
                    $alt=0;
                    $i=1;
                    foreach($contentdata as $eachrow){
                        ...
                        $modelname = "Offer";
                        $redirectionurl = "otherpages";      
						$recid = $eachrow['Offer']['id'];     
							$offer_page_name = $eachrow['Content']['title'];		
							...
							//echo '<pre>';print_r($offerpagename);
