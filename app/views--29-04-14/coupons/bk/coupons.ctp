...
<script type="text/javascript">
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){       
                if(act=="active"){
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/1/coupons/cngstatus";
                }else{
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/coupons/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrlAdmin+"changestatus/"+id+"/Offer/0/coupons/delete";
            }
        }else{
...
<div class="container">
   ...
   <div class="myclass">
            ...
            <?php echo $form->create("Admin", array("action" => "coupons",'name' => 'coupons', 'id' => "coupons")) ?>
            <script type='text/javascript'>
...
<?php } ?>
            <span class="titlTxt"> Offer Coupen  </span>
          ...
          <?php    $this->loginarea="offers";    $this->subtabsel="coupons";
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location='<?php echo $base_url_admin ?>coupons')" id="locaa"></span>
    ...
    <div class="tblData">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
                ...
                <th align="center" valign="middle" width="8%"><span class="right"><?php echo $pagination->sortBy('company_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),Company,null,' ',' ');?> </span>Merchant Name</th>
                <th align="center" valign="middle" width="8%"><span class="right"><?php echo $pagination->sortBy('offer_type_template_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),OfferTypeTemplate,null,' ',' '); ?></span>Offer Type</th>
                <th align="center" valign="middle" width="5%"><span class="right"><?php echo $pagination->sortBy('percent_pledge', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Related Event</th>
				<th align="center" valign="middle" width="5%"><span class="right"><?php echo $pagination->sortBy('coupon_value', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Value $</th>
				<th align="center" valign="middle" width="5%"><span class="right"><?php echo $pagination->sortBy('coupon_cost', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Cost $</th>
            ...
            <?php if($offerdata){ 
                    ...
                    foreach($offerdata as $eachrow){
                        ...
                        $related_event =$eachrow['Event']['title'] ;
						?>
                    <tr <?php echo $class;?>>	
						...
						e(
							$html->link(
								$html->tag('span',($related_event)?$related_event:'N/A'),
								array('controller'=>'offers','action'=>'addoffer',$recid),
								array('escape'=>false)
							)
						);
						...
						e(
							$html->link(
								$html->tag('span',($coupon_value)?$coupon_value:''),
								array('controller'=>'offers','action'=>'addoffer',$recid),
								array('escape'=>false)
							)
						);
						...
						e(
							$html->link(
								$html->tag('span',($coupon_cost)?$coupon_cost:''),
								array('controller'=>'offers','action'=>'addoffer',$recid),
								array('escape'=>false)
							)
						);
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="9" align="center">No Offer Coupen Found.</td></tr>
                <?php } ?>
        </table> 
