...
{   
    ...
    $('.checkid').each(function(){       
        ...
        if(id !=""){
                        if(op=="change"){       
                                if(act=="active"){
                                        window.location=baseUrl+"surveys/changestatus/"+id+"/1/Survey/surveylist/cngstatus";
                                        }else{
                                        window.location=baseUrl+"surveys/changestatus/"+id+"/2/Survey/surveylist/cngstatus";
                                        }
                        }
                        if(op=="del"){
                        if(confirm("You have selected "+count +" items to delete ?"))
                         ...
                         if(confirm("Are You Sure to delete the item"))
                            window.location=baseUrl+"surveys/changestatus/"+id+"/2/Survey/surveylist/delete";
                       }
}else{
