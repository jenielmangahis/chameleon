  ...
  <?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
    ...
    <span class="topRht_curv"></span>             
        <div class="gryTop">
                ...
                <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'relationships/others')" id="locaa"></span>
                </div>
...
<?php } ?>  
  ...
  <?php } }else{ ?>
  <tr><td colspan="7" align="center">No Other Found.</td></tr>
  <?php } ?>
  </table>
