...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"prospects/addmerchant/"+id; 
...
<div class="container">
         <div class="titlCont">
		  <div class="centerPage" >
            ...
            <?php echo $form->create("prospects", array("action" => "projectvendorslist",'name' => 'projectvendorslist', 'id' => "projectvendorslist")) ?>      
            <script type='text/javascript'>
            ...
            <span class="titlTxt">Vendors</span>
            ...
            <div class="topTabs">
                <ul class="dropdown">
					...
					<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'prospects','action'=>'addvendors'),
								array('escape' => false)
								)
							);
						?>
	         ...
	         <?php    $this->loginarea="prospects";    $this->subtabsel="projectvendors";
                        ...
                        <?php if($i%2 == 0) { ?>
                            <tr class='altrow'>	
                                ...
                                <td align="left" valign="middle" class='newtblbrd'>
									...
									array('controller'=>'prospects','action'=>'addvendors',$recid),
									array('escape' => false)
									)
								);
							?>
