...
<div class="slider" id="toppanel" style="height: 20px; top:13px;right: -50px;width:545px !important; text-align:right;">	<?php echo $form->create("prospects", array("action" => "addprospectemail",'type' => 'file','enctype'=>'multipart/form-data','name' => 'addprospectemail', 'id' => "addprospectemail","onsubmit"=>"return validateTaskForm();"));
