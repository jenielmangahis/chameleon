...
<?php
	...
	$resetUrl = $base_url.'players/types/category';
?>
...
<div class="titlCont1">
	<div class="centerPage">
		...
		<?php echo $form->create("players", array("action" => "addcategories",'name' => 'addcategories', 'type' => 'file','enctype'=>'multipart/form-data', 'id' => "addcategories","onsubmit"=>"return validatecategories('$act');"))?>
...
<!-- ADD FIELD BOF -->
	<div class="">
		...
		<table cellspacing="5" cellpadding="0" align="left" width="815px"
			...
			<tbody>
				...
				<?php }?>
				<tr>
					<td width="15%" align="right"><label class="boldlabel">Category
					...
					<td width="85%">
						...
						<span class="intpSpan" id="spancattext"
						style="display: none"><?php echo $form->input("Category.category_name_text", array('id' => 'category_name_text', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "200"));?>
					</span> <input type="hidden" id="hidcatname" name="hidcatname"
						value="category_id" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="85%">&nbsp;&nbsp; <?php if(isset($this->data['CategoryDetail']['id'])){ ?>
			...
			<button type="button" value="cancel" class="button"  id="btneditcancel"  style="display:none">
				<span>Cancel</span>
						...
						<button type="button" value="save" class="button" id="btnsave"
							style="display: none">
							<span>Save</span>
						</button>
						<button type="button" value="cancel" class="button" id="btncancel"
							style="display: none">
							<span>Cancel</span>
						</button> <?php } ?>
				...
				<tr>
					<td width="15%" align="right"><label class="boldlabel">Sub-Category
							Name </label></td>
					<td width="85%"><span class="txtArea_top" id="spansubcat"><span
							class="txtArea_bot"><span id="compdiv"> <?php echo $form->select("CategoryDetail.sub_category_id", $subcategorydropdown, $selectedsubcategory, array('id' => 'sub_category_id','class'=>'multilist'),"---Select---");?>
							</span> </span> </span> <span class="intpSpan"
						id="spansubcattext" style="display: none"><?php echo $form->input("Category.sub_category_name_text", array('id' => 'sub_category_name_text', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "200"));?>
					</span> <input type="hidden" id="hidsubcatname"
						name="hidsubcatname" value="sub_category_id" />
					</td>
				</tr>
				...
				<button type="button" value="cancel" class="button"  id="btnsubeditcancel"  style="display:none">
					<span>Cancel</span>
						...
						<button type="button" value="save" class="button" id="btnsubsave"
							style="display: none">
							<span>Save</span>
						</button>
						<button type="button" value="cancel" class="button"
							id="btnsubcancel" style="display: none">
							<span>Cancel</span>
						</button> <?php } ?>
					</td>
				</tr>
				...
				<tr>
					<td width="15% " align="right"><label class="boldlabel">Description
							<span style="color: red;">*</span>
					</label></td>
					<td width="85%">&nbsp;&nbsp;&nbsp; <span class="txtArea_top"><span
							class="txtArea_bot"><?php echo $form->textarea("CategoryDetail.description", array('id' => 'description', 'div' => false, 'label' => '','cols' => '36', 'rows' => '4',"class" => "noBg"));?>
						</span> </span>
					</td>
				</tr>
				...
				<tr>
					...
					<td valign='top' align="right"><label class="boldlabel">Square
							Graphic</label></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $form->file('CategoryDetail.square_graphic',array('id'=> 'square_graphic',"class" => "contactInput"));?><br>
						&nbsp;&nbsp;&nbsp;&nbsp;<span
						style="color: LightSlateGray; font-size: 11px; font-style: italic;">Used
							for 210X210 formats of image formatted appropriately.</span> <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<?php 
				...
				<tr>
					...
					<td valign='top' align="right"><label class="boldlabel">Wide
							Graphic</label></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $form->file('CategoryDetail.wide_graphic',array('id'=> 'wide_graphic',"class" => "contactInput"));?><br>
						&nbsp;&nbsp;&nbsp;&nbsp;<span
						style="color: LightSlateGray; font-size: 11px; font-style: italic;">Used
							for 350X210 formats of image formatted appropriately.</span> <br />&nbsp;&nbsp;&nbsp;&nbsp;
						<?php 
				...
				<tr>
					...
					<td valign='top' align="right"><label class="boldlabel">Tall
							Graphic</label></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $form->file('CategoryDetail.tall_graphic',array('id'=> 'tall_graphic',"class" => "contactInput"));?><br>
						&nbsp;&nbsp;&nbsp;&nbsp; <span
						style="color: LightSlateGray; font-size: 11px; font-style: italic;">Used
							for 210X350 formats of image formatted appropriately.</span> <br />&nbsp;&nbsp;&nbsp;&nbsp;
						<?php 
				...
				<tr>
					<td width="40%">
						...
						<div class="top-bar"
							style="margin-bottom: 10px; text-align: left; padding: 20px 5px 5px 60px; color: black;">
