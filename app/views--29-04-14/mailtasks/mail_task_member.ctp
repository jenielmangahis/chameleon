	...
	<tbody>
		<tr>
			...
			echo $form->select("CommunicationTask.email_template_id",$templatedropdown,$sel_email_temp,array('id' => 'email_template_id','class'=>'multilist','onchange'=>'getEmailTemplate(this.value)'),array('0'=>'--Select--')); ?>
						...
						<tr>
							<td align="right"><label class="boldlabel">Donation Level</label>
							</td>
							<td><span class="txtArea_top"> <span class="txtArea_bot"> <?php //$donation_levels = array();
	 ...
	 echo $form->input('CommunicationTask.member_birthday', array('id'=>'member_birthday','type'=>'checkbox', 'label' => '', 'checked' => $chked)); ?></td>
						...
						<tr>
							<td align="right"><label class="boldlabel">Points Range</label></td>
							<td><span class="intpSpan middle"><?php echo $form->text("CommunicationTask.member_points_rangefrom", array('id' => 'member_points_rangefrom', 'value'=>$sdate, 'div' => false, 'label' => '',"class" => "inpt_txt_fld","style" => "width:100px","maxlength" => "200"));?>
							</span>&nbsp; to &nbsp; <span class="intpSpan middle"><?php echo $form->text("CommunicationTask.member_points_rangeto", array('id' => 'member_points_rangeto', 'value'=>$sdate, 'div' => false, 'label' => '',"class" => "inpt_txt_fld","style" => "width:100px","maxlength" => "200"));?>
							</span></td>
						</tr>
...
?></td>
						...
						<tr>
							<td align="right"><label class="boldlabel">Relates to comment</label>
							</td>
							<td><span class="txtArea_top"> <span class="txtArea_bot"> <span id="countrydiv">
					<?php echo $form->select("CommunicationTask.relatesto_commenttype_id",$commenttypedropdown,$sel_comment_typeid,array('id' => 'relatesto_commenttype_id',"class"=>"multilist"),array(''=>'--Select--')); ?></span>
								</span>
							</span>&nbsp;&nbsp; <span class="btnLft">
									<input type="button" id="btn_relate_to_comment" class="btnRht" value="Add" onclick="addCommentTypeforTask();"	name="Add" />
							</span> <!-- <input type="button"  class="btnRht" value="Add" name="Add" ONCLICK=" javascript:(window.location='/admins/addcommenttype')" /></span>-->
							</td>
						</tr>
