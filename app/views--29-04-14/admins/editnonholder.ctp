...
<div class="container">    
    <div class="titlCont">
        <div style="width:960px; margin:0 auto;">
            <?php /*?><div align="center" class="slider" id="toppanel" style="height: 20px;">
            ...
            <span class="titlTxt">Edit Contact Info
            </span>
...
<select maxlength="250" class="" style="background: none repeat scroll 0% 0% transparent; margin-bottom: 6px; width:230px;" label="" div="" id="member_type" name="data[Holder][member_type]">
