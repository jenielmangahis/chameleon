...
<?php $pagination->setPaging($paging); ?>  
    <div class="titlCont">
        <div style="width:960px; margin:0 auto;">
           ...
           <?php echo $form->create("Admins", array("action" => "membercomments/$recordid",'name' => 'membercomments', 'id' => "membercomments")) ?>      
            ...
            <div class="topTabs">
               <!-- <ul>
                    ...
                    <li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='/< ?php echo $lgrt;?>')"><span> Cancel</span></button></li>
                        ...
                        <?php    $this->loginarea="admins";    $this->subtabsel="comments";
  ...
  <div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location='/admins/membercomments/<?php echo $recordid;?>')" id="locaa">&nbsp;&nbsp;  
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
              ...
              <!--  <th align="center" valign="middle" style="width:3%"><input type="checkbox" value="" name="checkall" id="checkall" /></th> -->
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('comment_date', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Date</th>
                <th align="center" valign="middle" style="width:8%"><span class="right"><?php echo $pagination->sortBy('comment_date', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Time</th>
                <th align="center" valign="middle" style="width:28%"><span class="right"><?php echo $pagination->sortBy('comment_type_name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Type</th>
                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('is_additional_allowed', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Suggested/Add'l</th>
                <th align="center" valign="middle" style="width:35%"><span class="right"><?php echo $pagination->sortBy('commentdata', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Comment</th>
