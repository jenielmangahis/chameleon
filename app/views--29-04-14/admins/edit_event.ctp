...
<?php  echo $this->renderElement('project_name');  ?> 
	...
	<?php echo $form->create("Admin", array("action" => "edit_event",'type' => 'file','enctype'=>'multipart/form-data','name' => 'edit_event', 'id' => "edit_event","onsubmit"=>"return validateevent('$act');"))?>
                   ...
                   <li>
						<?php
							e($html->link(
								...
								array('controller'=>'admins','action'=>'eventtasklist',$this->data['RecurringEvent']['id']),
								array('escape' => false)
								)
							);
					?>
...
<table cellspacing="5" cellpadding="0" >
    ...
    <tr>
        ...
        <label class="boldlabel">Maximum # Attendees <span style="color: red;">*</span></label>
            ...
            <tr>
            <td><span class="intpSpan"><?php echo $form->input("RecurringEvent.max_attendees", array('id' => 'max_attendees', 'div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "150",'style'=>'width:70px;'));?></span> </td>
            <td valign="top" style="width: 44px; padding: 3px 6px 9px 16px;">Start #</td>
            <td><span class="intpSpan"><?php 
                //if($act=="edit")    $read_only="readonly";                
                 echo $form->input("RecurringEvent.show_attendees_start", array('id' => 'show_attendees_start','div' => false, 'label' => '',"class" => "inpt_txt_fld","maxlength" => "150",'style'=>'width:70px;'));?></span>
            </tr>
            </table>
       ...
       <!-- <tr>
        ...
        <td>
            <span class="txtArea_top">
                <span class="txtArea_bot">
                <?php echo $form->select("RecurringEvent.rsvp_email",$templatedropdown,null,array('id' => 'rsvp_email','class'=>'multilist'),array(''=>'--Select--')); ?>		    
        ...
        <tr>
			...
			<span class="txtArea_top">
						<span class="txtArea_bot">
							<?php echo $form->select("RecurringEvent.waitlist_email",$templatedropdown,null,array('id' => 'waitlist_email','class'=>'multilist'),array(''=>'--Select--')); ?>
						</span>
					</span>
        ...
        <label class="boldlabel">Event Detail Page </label>
            ...
            <td>
                            ...
                            <span class="txtArea_top">
                    <span class="txtArea_bot">
                        <?php echo $form->select("RecurringEvent.event_detail_page",$submenu,null,array('id' => 'event_detail_page','class'=>'multilist'),array(''=>'--Select--')); ?>
                    </span>
                </span>
                <span class="btnLft"><input type="button"  class="btnRht" value="Edit" name="Add" id="event_detail_btn" onclick="addContentforEventDetails();" /></span>
        ...
        <label class="boldlabel">Sponsor Detail Page </label>
            ...
            <td>
              <span class="txtArea_top">
                                          <span class="txtArea_bot">
                                            <?php echo $form->select("RecurringEvent.sponsor_detail_page",$submenu,null,array('id' => 'sponsor_detail_page','class'=>'multilist'),array(''=>'--Select--')); ?>
                                          </span>
                                          </span>
        ...
        <label class="boldlabel">Inquiry Detail Page </label>
            ...
            <td>
              ...
              <span class="txtArea_top">
                                          <span class="txtArea_bot">
                                            <?php echo $form->select("RecurringEvent.inquiry_detail_page",$submenu,null,array('id' => 'inquiry_detail_page','class'=>'multilist'),array(''=>'--Select--')); ?>
                                          </span>
                                          </span>
...
<td width="50%" valign="top">
       ...
       <tr>
        ...
        <label class="boldlabel">Short Description  </label>
            ...
            <td>
            <span class="txtArea_top">
                <span class="txtArea_bot"><?php echo $form->textarea("RecurringEvent.eventdescription", array('id' => 'eventdescription',  'div' => false, 'label' => '','cols' => '35', 'rows' => '8',"class" => "noBg",'style'=>'width:231px;'));?></span></span></td>
        </tr> 
        ...
        <label class="boldlabel">Meta Description  </label>
            ...
            <td>
            <span class="txtArea_top">
                <span class="txtArea_bot"><?php echo $form->textarea("RecurringEvent.meta_description", array('id' => 'meta_description',  'div' => false, 'label' => '','cols' => '35', 'rows' => '8',"class" => "noBg",'style'=>'width:231px;'));?></span></span></td>
        </tr> 
 ...
 /**
         ...
         */
         function addEmailTempforRSVP() {   
                      $('#rsvp_email').focus();
             var resWindow=  window.open (baseUrlAdmin+'addmailtemplate/popup/event', 'AddTemp','location=1,status=1,scrollbars=1, width='+w+',height='+h);
             resWindow.focus();
           }
