...
<div id="center-column">
	<div class="top-bar" style="border-left:0px;">
		...
		<div class="left">
		<?php echo $form->create("Admins", array("action" => "editprojectdesc",'name' => 'editprojectdesc', 'id' => "editprojectdesc",'onsubmit'=>'return validateprojectdetail("editdesc")')); ?>
		<table cellspacing="10" cellpadding="0" align="center" width="815px">
		  <tbody>
		    ...
		    <tr>
		     ...
		     <td width="90%"><?php echo $form->input("Project.titleshortdescription", array('id' => 'titleshortdescription', 'div' => false, 'label' => '','style' =>'width:400px;',"class" => "contactInput","maxlength" => "250"));?></td>
		    </tr>
		    <tr>
		      <td width="10%" valign='top'><label class="boldlabel">Content: </label></td>	
		      <td width="90%">
			<?php echo $form->textarea("Project.descriptionshort", array('id' => 'descriptionshort', 'div' => false, 'label' => '','cols' => '24', 'rows' => '4',"class" => "contactInput"));?>
		    ...
		    <tr>
		     <td width="10%"><label class="boldlabel">Title: <span style="color:red">*</span></label></td>
		     <td  width="90%">
		    	<?php echo $form->input("Project.titlelongdescription", array('id' => 'titlelongdescription', 'div' => false, 'label' => '','style' =>'width:400px;',"class" => "contactInput","maxlength" => "250"));?></td></tr>
		     <tr>
		      <td width="10%"  valign='top'><label class="boldlabel">Content: </label></td>	
		      <td width="90%">
		      <?php echo $form->textarea("Project.descriptionlong", array('id' => 'descriptionlong', 'div' => false, 'label' => '','cols' => '24', 'rows' => '4',"class" => "contactInput"));?>
			</td>
		    </tr>	
