...
//echo $form->create("Admins", array("action" => "memberpoints/$recordid",'type' => 'file','enctype'=>'multipart/form-data','name' => 'memberpoints', 'id' => "memberpoints"));
            ...
            <span class="titlTxt">Link History</span>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="trBg">
              ...
              <!--  <th align="center" valign="middle" style="width:10px"><input type="checkbox" value="" name="checkall" id="checkall" /></th>-->
                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('created', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' ');?></span>Click Date</th>
				
				
                <th align="center" valign="middle" style="width:30%"><span class="right"><?php echo $pagination->sortBy('Point_Name', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Link Address</th>
                ...
                <th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('points', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Clicks </th>

                <th align="center" valign="middle" style="width:15%"><span class="right"><?php echo $pagination->sortBy('point_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Redirect</th>

<th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('point_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Recur Type</th>
               

<th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('point_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Placement</th>
               

<th align="center" valign="middle" style="width:14%"><span class="right"><?php echo $pagination->sortBy('point_level', $html->image('sorting_arow.png',array('width'=>'10','height'=>'13','alt'=>'')),null,null,' ',' '); ?></span>Status</th>
								  ...
								  <td align="left" valign="middle" class='newtblbrd'><span><?php echo $linkdata['Link']['link_visule_text'] ; ?></span></td>
									 <td align="left" valign="middle" class='newtblbrd'><span><?php echo $linkdata['Link']['recur_type'] ; ?></span></td>
									  <td align="left" valign="middle" class='newtblbrd'><span><?php echo $linkdata['Link']['placement'] ; ?></span></td>
									   <td align="left" valign="middle" class='newtblbrd'><span><?php if($linkdata['Link']['status']  === 'a') { echo "Active" ; } elseif($linkdata['Link']['status']  === 'd'){ echo "InActive"; } ?></span></td>
