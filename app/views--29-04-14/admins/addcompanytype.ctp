...
<div class="midPadd">
	...
	<?php if($session->check('Message.flash')) { echo $this->renderElement('error_message'); } ?>
		...
		<tr>
		<td width="32%"  align="right"><label class="boldlabel">Company Type <span style="color: red;">*</span></label></td>
			<td width="85%">
				<span class="txtArea_top" id="spancat"><span class="txtArea_bot"><span id="compdiv">
				<?php $companytypecategorydropdown = array() ; echo $form->select("CompanyType.company_type_name", $companytypecategorydropdown, $selectedcompanytypecategory, array('id' => 'company_type_category_name','class'=>'multilist'),"---Select---");?>
				</span></span></span>
		...
		<tr><td align="right" valign="top"><label class="boldlabel">Notes </label></td>
                <td><span class="txtArea_top">
                          ...
                          <?php echo $form->textarea("CompanyType.note", array('id' => 'note', 'div' => false, 'label' => '','cols' => '27', 'rows' => '5',"class" => "noBg"));?>
                          </span></span>
                </td>
