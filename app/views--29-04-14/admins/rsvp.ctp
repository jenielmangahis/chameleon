...
$rec_event_id = '';
    ...
    if(isset($arr[4]) && $arr[4]=="pastevent")
        $hide_menu=1;
    else
        $hide_menu=0;
?>
...
<div class="container">
   ...
   <div class="myclass">
            ...
            <script type='text/javascript'>
			 ...
			 <span class="titlTxt">   RSVP : Event Name  </span>
        ...
        <div style="height: 30px; clear: both;">
            <?php $this->loginarea="admins";    $this->subtabsel="rsvp";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <?php if($eventdata){ 
                    ...
                    <tr <?php echo $class;?>>    
                        ...
                        <?php echo $last_name?$last_name:'N/A'; ?>
                        <?php
									
									e($html->link(
									$html->tag('span', $last_name?$last_name:'N/A'),
									array('controller'=>'admins','action'=>'editnonholder', $holder_id),
									array('escape' => false)
									)
								);
							?>
                    ...
                    <?php } }else{ ?>
                <tr><td colspan="9" align="center">No RSVP Found.</td></tr>
                <?php } ?>
        </table> 
    </div>
    <div>
