...
$backUrl = $base_url.'offers/responderhistory';
...
{   
 ...
 function editcontent()
        ...
        if(counter!=1)
        {
                ...
                document.getElementById("linkedit").href=baseUrl+"offers/responderhistory/"+id;                 
            }
       } 
    ...
    $('.checkid').each(function(){       
        ...
        {           
            if(id==""){
                ...
                ++count;
                        ...
                        if(id !=""){
                                        if(op=="change"){       
                                                if(act=="active"){
                                                        window.location=baseUrl+"offers/changestatus/"+id+"/CommunicationTaskHistory/1/responderhistory/cngstatus";
                                                        }else{
                                                        window.location=baseUrl+"offerss/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/cngstatus";
                                                        }
                                        }
                                        if(op=="del"){
			...
			if(confirm("Are you sure to delete the item ?"))
                                        window.location=baseUrl+"offers/changestatus/"+id+"/CommunicationTaskHistory/0/responderhistory/delete";
                                        }
                        }else{
...
<div class="slider" id="toppanel" style="height: 20px; top:13px;right:103px;width:545px !important; text-align:right;">			

   <?php echo $form->create("offers", array("action" => "responderhistory",'name' => 'responderhistory', 'id' => "responderhistory")) ?>
                <script type='text/javascript'>
...
<!--li><a href="javascript:void(0)" onclick="editcontent();" id="linkedit"><span>Edit</span></a></li-->
               ...
               <?php    $this->loginarea="offers";    $this->subtabsel="responderhistory";
