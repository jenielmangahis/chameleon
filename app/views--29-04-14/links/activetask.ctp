...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"mailtasks/addtask/edit/"+id; 
        ...
        if(id !=""){
            ...
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"mailtasks/changestatus/"+id+"/CommunicationTask/0/activelist/delete";
            }
        }else{
...
?>			
            ...
            <?php echo $form->create("mailtasks", array("action" => "activelist",'name' => 'activelist', 'id' => "activelist")) ?>      
			<script type='text/javascript'>
            ...
            <div class="topTabs">
                <ul class="dropdown">
					...
					<?php
							e($html->link(
								$html->tag('span', 'New'),
								array('controller'=>'mailtasks','action'=>'addtask'),
								array('escape' => false)
								)
							);
						?>
            ...
            <div class="clear" ></div>
	        <?php
			 		$this->loginarea="mailtasks";    $this->subtabsel="activetask";
        ...
        <div class="tblData">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				if($taskdata){ 
                        ...
                        $recurOn="";
                        $templatetypearrary = array('0'=>'Member','1'=>'Player','2'=>'mailtasks','3'=>'Offer');
               ...
               <td align="center" class='newtblbrd'><a><span><input type="checkbox"  class="checkid" name="checkid[]" value="<?php echo $recid; ?>" /></a></span></td>
				...
				<?php
						e($html->link(
							...
							array('controller'=>'mailtasks','action'=>'addtask','edit',$recid),
							array('escape' => false)
							)
						);
				?>
