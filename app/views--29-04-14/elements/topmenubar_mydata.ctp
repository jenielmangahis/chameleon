...
$url="/";
if($_SERVER['HTTP_HOST']=="www.coins4promo.com")
{
    $url="/$project_name";
}
?>
	...
	<?php 	
		$condition = "Content.project_id='".$project['Project']['id']."' and Content.active_status='1' and Content.delete_status='0' and parent_id ='0' and Content.alias !='privacy' and Content.alias !='terms' ".$globalcondition." ".$showcommenttab;
	...
	{
		if($page_url=="home_page" || $page_url=="home-page") { ?>
			<li><a href="<?php echo $url; ?>" <?php if($page_url=="home_page") echo 'class=active' ;  ?>><span><?php
		 $title0 =$convalue['Content']['title'];
		if($title0){$title0 =AppController::WordLimiter($title0,20);}
		 echo $title0;
		?></span></a></li><li>|</li>
		<?php
		} else {
{?>
		...
		<li><a href="/<?php echo $convalue['Content']['alias'];?>" <?php if($page_url== $convalue['Content']['alias']) echo 'class=active' ;  ?>> <span><?php
		...
		if ($submenus!="")
			{?>	
				...
				{ ?> 
					...
					<li  class="sub" >
					<a href="/<?php echo $submenu['Content']['alias'];?>" <?php if($page_url== $submenu['Content']['alias']) echo 'class=active' ;  ?>><?php 
...
?>
  	...
  	<li><a href="/<?php echo $convalue['Content']['alias'];?>" <?php if($page_url== $convalue['Content']['alias']) echo 'class=active' ;  ?>><span><?php echo $convalue['Content']['title'];?></span></a>
	...
	if ($submenus!="")
		{
			...
			<ul>
				<li>
				<a href="/<?php echo $submenu['Content']['alias'];?>" <?php if($page_url== $submenu['Content']['alias']) echo 'class=active' ;  ?>><span><?php echo $submenu['Content']['title'];?></span></a>
				</li>
			</ul>
			<?php } } ?>
