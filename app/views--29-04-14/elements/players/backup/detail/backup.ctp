...
<td align="right" width="40%" class="lbltxtarea"><label class="boldlabel">Pintrest Page <span style="color: red;"></span></label></td>
		...
		<tr>			   	
				<td valign="top" align="right">
					<label class="boldlabel">Targeted Projects<p class="subtext"> ( Existing projects <br />for target players)</p></label>
				</td>
				<td>
					  <div class="large" >
					  	<span class="txtArea_top">
...
echo (!empty($checkedrelproject) && in_array($projectdata['Project']['id'],$checkedrelproject))?'checked="checked"' :'';											
		   ...
		   <tr>			   	
				<td valign="top" align="right">
					<label class="boldlabel">Related Non-Profits<p class="subtext">(Existing Non-Profits players is aligned with)</p></label>
				</td>
				<td>
					  <div class="large" >
					  	<span class="txtArea_top">
