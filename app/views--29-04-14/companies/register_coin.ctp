        ...
        <div class="boxBor1">
            <div class="boxPad">
                                        ...
                                        <?php 
                                            ...
                                            if($coinsdetail['Coinset']['serialdisplayside']=="A") {
                                                if($coinsdetail['Coinset']['sidea']=="")
                                                    ...
                                                    echo $html->image('/img/'.$project_name.'/uploads/'.$coinsdetail['Coinset']['sidea'], array('class'=>'','width'=>'160','height'=>'160'));
                                            }
                                            else
                                            {
                                            ?><?php //echo $html->image('/img/'.$project_name.'/spacer.gif', array('width'=>'20','height'=>'1'));?><?php 
                                                if($coinsdetail['Coinset']['sideb']=="")
                                                    ...
                                                    echo $html->image('/img/'.$project_name.'/uploads/'.$coinsdetail['Coinset']['sideb'], array('class'=>'','width'=>'160','height'=>'160'));
                                            }
                ...
                <div style="margin: 0pt auto; width: 360px;">
                    ...
                    <?php echo  $form->create('Coinset',array('action'=>'register_coin','name'=>'coin_frm','id'=>'','url'=>'register_coin','onsubmit' => 'return validatecoinserial("add");'));?>
