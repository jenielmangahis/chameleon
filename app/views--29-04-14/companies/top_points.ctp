...
<div class="container">
       <div class="titlCont"><div style="width:960px; margin:0 auto;">
            ...
            <?php echo $form->create("Companies", array("action" => "top_points",'name' => 'top_points', 'id' => "top_points")) ?>
            <script type='text/javascript'>
            ...
            <!--<div class="topTabs">
             ...
             <?php    $this->loginarea="companies";    $this->subtabsel="top_points";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location='/companies/top_points')" id="locaa">&nbsp;&nbsp;  
    ...
    <div class="gryBot"><?php if($top_points_arr) { echo $this->renderElement('newpagination'); } ?>
