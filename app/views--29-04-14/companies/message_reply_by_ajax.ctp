                                    ...
                                    <?php if(sizeof($msgReplyArray)==0){?> 
                                        ...
                                        <?php }else{    //DebugBreak();
                                            ...
                                            <tr>
                                                ...
                                                <?php  echo ucfirst(str_replace($holder_name,"Me",$replyData['MessageReply']['holdername']));  ?> | <?php  echo date("M d, Y", strtotime($replyData['MessageReply']['created']));  ?>
                                                </td>
                                              </tr>
                                            <tr>
                                             <td  class="forName" >    
                                                <span class=""><?php echo stripslashes($replyData['MessageReply']['reply_content']);  ?>  </span></td>
                                            </tr> 
