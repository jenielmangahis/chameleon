...
<?php echo $form->create("Companies", array("action" => "eventinvitation",'type' => 'file','enctype'=>'multipart/form-data','name' => 'eventinvitation', 'id' => "eventinvitation", 'onsubmit'=>'return inviteevent()')); ?>
<span class="titlTxt">
...
<li><a href="/companies/eventinvitation/<?php echo $eventid;?>" class="tabSelt"><span>Invite</span></a></li>
