...
<div class="titlCont1">
    <div class="myclass">
        ...
        <?php echo $form->create("Company", array("action" => "formsubmitted/$formubmittedid",'type' => 'file','enctype'=>'multipart/form-data','name' => 'formtype_add', 'id' => "formtype_add" , "onsubmit"=>""));  //"onsubmit"=>"return validate_form('$act');" 
        if($formtypeid){
        ...
        <div class="topTabs">
            <ul>
                ...
                <li><button type="button" id="saveForm" class="button"  ONCLICK="javascript:(window.location='/companies/formsubmitlist')"><span> Cancel</span></button></li>
            </ul>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="50%" valign="top"> 
                                ...
                                <tbody>
                                    <tr>
                                        <td width="50%" valign="top" align="right"> <label class="boldlabel">Name of Form</label>   </td>
                                    ...
                                    <tr>
                                        <td  valign="top" align="right"> <label class="boldlabel">Current Status</label>   </td>
                          ...
                          <?php
                               $statehtml="<tr> <td  align='right' valign='top'> <label class='boldlabel'>".ucfirst($fldnm_lbl); ?>
                          ...
                          <?php  }else if($fldnm=="list1" || $fldnm=="list2"){     
                              ...
                              <?php  }else {
                                     if($fldnm=="firstname") {
                                      ...
                                      <tr> 
                                    <td  align='right' valign='top'><label class='boldlabel'><?php echo $fldnm_lbl; ?>
                                    <?php if($this->data['FormType'][$req_fldnm]=='1'){   ?>
                                        <span style="color: red;">*</span>   
                                        <?php }?>
                                    </label>
                        ...
                        ?>
                            ...
                            <td width="50%" valign="top"> 
                                ...
                                <tbody>
                                     <tr>
                                        <td width="50%" valign="top" align="right"> <label class="boldlabel">Date Submitted</label>   </td>
                                     ...
                                     <tr>
                                        <td width="50%" valign="top" align="right"> <label class="boldlabel">Date of Status</label>   </td>
                                      ...
                                      <tr>
                            <td  align="right" valign="top" > <label class="boldlabel">Company Type</label></td>
                            <td >
                                      <span class="txtArea_top">
                                <span class="txtArea_bot">
                         ...
                         <tr>
                            <td  align="right" valign="top" > <label class="boldlabel">Contact Type</label></td>
                            <td  >
                                      <span class="txtArea_top">
                                <span class="txtArea_bot">
