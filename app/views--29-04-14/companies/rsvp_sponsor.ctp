...
<ul class="topTabs2">
                  ...
                  <li><a href="/companies/rsvp_sponsor/<?php echo $rec_event_id; if($hide_menu==1) echo "/pastevent";?>" class="tabSelt"><span>RSVP</span></a></li>
                  <?php
     if($waiting_list==1)  
                   {
                    ?>
...
<div class="midCont">
    ...
    <div>
        ...
        <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="javascript:(window.location='/companies/downloadrsvp/<?php echo $rec_event_id;?>')" > </span>
