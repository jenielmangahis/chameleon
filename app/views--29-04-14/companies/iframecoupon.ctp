                                	...
                                	<?php if(isset($coupondata)){
                                        if(sizeof($coupondata) > 0){
                                            ...
                                            <div class="blogarticle margin4px">
                                                <div class="blogtitle margin4px"><a href="iframecoupon/0/<?php echo $eachrow['Coupon']['id']; ?>" title="<?php echo $eachrow['Coupon']['title'] ?>" id="blogtitle">  
                                                    <?php echo  $eachrow['Coupon']['title'] ?> </a> 
                                                </div>
                                                <div class="grayText margin4px"> <?php echo date("F d, Y", strtotime($eachrow['Coupon']['starttime'])); ?> </div>
                                                <div class="margin4px">
                                                    <span><?php echo $eachrow['Coupon']['short_description']; ?> </span>
                                                    <span  style="float: right;"> 
                                                    <a href="iframecoupon/0/<?php echo$eachrow['Coupon']['id']; ?>" title="<?php echo $eachrow['Coupon']['title']; ?>" class="orangeText" style="font-size: 11px;"> Read More</a>   </span>
                                                </div>
                                                <div class="line margin4px"><?php echo $html->image('/img/spacer.gif');?> </div>
                                            </div>
                                            <?php }
                                            if(count($coupondata)>=$eventlimit)
                                            {
                                        ?>
                                        <div style="float: right;"><a href="iframecoupon/<?php echo $eventlimit+$eventoffset; ?>" id="morecomment" >More Coupons</a> </div>
                                        <?php
                                            }
                                        }
                                        else{
										...
										if($is_wp){
	                                        $event_details_page   =  $couponrow['Event']['wp_event_detail_page'];
											$inquiry_details_page = $couponrow['Event']['wp_inquiry_detail_page'];
                                        }else{
											$event_details_page   = $couponrow['Event']['event_detail_page'];
											$inquiry_details_page = $couponrow['Event']['inquiry_detail_page'];
                                        }
                                        ...
                                        <div class="margin4px" style="position: relative; width: 900px; height: 35px;font-size: 18px;"> 
                                            <div style="float: left; position: relative; width: 215px;"><b><?php echo $couponrow['Coupon']['title']; ?></b>
                                            <br>
                                            <?php if($username) {  ?>
                                            ...
                                            <div style="float: left; position: relative; margin-left: 10px;width: 315px;">Coupon:<?php echo $couponrow['Coupon']['title']; ?> 
                                            <br>
                                             <?php if($username)
                                            {
                                                ?>
...
<?php echo $form->button('RSVP', array('div'=>false,"class"=>"flx_flexible_btn_red",'style'=>'font-size:12px;','onclick'=>"window.open('/companies/rsvp/".$couponrow['Coupon']['id']."','windowname1','width=750, height=450,resizable=no,scrollbars=1'); return false;"));?> 
                                       ...
                                       <div class="margin4px" style="position: relative;  float:left; text-align: center;"> 
                                        	<a href="<?php echo $event_details_page ?>" >
                                                  <?php if($couponrow['Coupon']['small_pic'] !=''){ 
															$attrimg = array('height'=>'200px', 'width'=>'200px;');
															echo $html->image('project/uploads/'.$couponrow['Coupon']['small_pic'], $attrimg);
													 }else { ?>
                                        ...
                                        <div class="blogarticle margin" style="float: left; position: relative; width: 50%; margin-top: 0px">
											...
											<ul style="list-style: none" class="contentlist">
												<li><b>Member Price:</b>&nbsp;&nbsp;$<?php echo $couponrow['Coupon']['coupon_cost']; ?></li>
												<li><b>Non-Member Price:</b>&nbsp;&nbsp;$<?php echo $couponrow['Event']['non_member_price']; ?></li>
												<li><b>Location:</b> <?php echo $couponrow['Event']['location']; ?></li>
												<li><b>Address:</b> <?php echo $couponrow['Event']['address']; ?></li>
												<li><b>Date and Time:</b> <?php echo date("F j, Y", strtotime($couponrow['Coupon']['starttime'])); ?></li>
												<li><b>Sart Time: </b><?php echo date("F j, Y, g:i a", strtotime($couponrow['Coupon']['starttime'])); ?></li>
												<li><b>End Time: &nbsp;</b><?php echo date("F j, Y, g:i a", strtotime($couponrow['Coupon']['endtime'])); ?></li>
												<li><b>Max. Attendees:</b> <?php echo $couponrow['Event']['max_attendees']; ?> &nbsp;&nbsp;<b># Attending:</b> <?php echo $couponrow['Event']['max_attendees_start']; ?></li>
												<li><b>RSVP Required:</b><?php if($couponrow['Event']['rsvp_required']==1) echo"Yes"; else echo "No"; ?></li>
												<li></li>
											</ul>
                                              <?php if($username){
                                              ...
                                              <div id="leavecomment">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" id="event_id" name="event_id" value="<?php echo  $couponrow['Event']['id']; ?>"/>
                                                    </div>
                                                    <br />
                                                    &nbsp;&nbsp;
                                                ...
                                                <?php 
                                                    ...
                                                    ?>
                                                    <input type="hidden" id="event_id" name="event_id" value="<?php echo  $couponrow['Coupon']['id']; ?>"/>  
                                             <?php   }?>
                                        </div>
                                        ...
                                        <div class="clear"></div>
                                         ...
                                         <div>
                                            <b>Description:</b>
                                            <?php echo  $couponrow['Coupon']['short_description']; ?> 
                                        </div>
