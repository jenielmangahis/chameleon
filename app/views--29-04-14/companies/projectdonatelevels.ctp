...
<script type="text/javascript">
    ...
    {	
        ...
        if(counter!=1)
            ...
            document.getElementById("linkedit").href=baseUrl+"companies/projectdonatelevels_add/"+id; 
        }
    } 
    ...
    {   
        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    window.location=baseUrl+"companies/changestatus/"+id+"/DonationLevel/1/projectdonatelevels/cngstatus";
                }else{
                    window.location=baseUrl+"companies/changestatus/"+id+"/DonationLevel/0/projectdonatelevels/cngstatus";
                }
            }
            if(op=="del"){
                if(confirm("You have selected "+count +" items to delete ?"))
                    ...
                    window.location=baseUrl+"companies/changestatus/"+id+"/DonationLevel/0/projectdonatelevels/delete";
            }
        }else{
...
<div class="container">
       <div class="titlCont"><div style="width:960px; margin:0 auto;">
            ...
            <?php echo $form->create("Company", array("action" => "projectdonatelevels",'name' => 'projectdonatelevels', 'id' => "projectdonatelevels")) ?>
            <script type='text/javascript'>
            ...
            <div class="topTabs">
				...
				<?php
					e($html->link(
					$html->tag('span', 'New'),
					array('controller'=>'companies','action'=>'projectdonatelevels_add'),
					array('escape' => false)
					)
				);
				?>
            ...
            <?php    $this->loginarea="companies";    $this->subtabsel="projectdonatelevels";
...
<div class="midCont" id="newhldtab">
    ...
    <div>
      ...
      ?> 
            ...
            <span class="srchBg2">
                <input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/projectdonatelevels')" id="locaa">&nbsp;&nbsp;  
           </span>
    ...
    <div class="tblData">
       ...
       <?php if($donationlevellist){ $i=1;         
           ...
           ?>
            <tr class='<?php echo $cls; ?>'>    
			 ...
			 <?php
				e($html->link(
					...
					array('controller'=>'companies','action'=>'projectdonatelevels_add',$recid),
					array('escape' => false)
					)
				);
			?>
			...
			if($eachrow['DonationLevel']['active_status']=='1'){ 
					if(isset($eachrow['DonationLevel']['level_name'])){
						$data=$eachrow['DonationLevel']['level_name'];
					}
						else{
							$data='';
						...
						e($html->link(
								$html->image('deactive.gif',array('width'=>'10','height'=>'13','alt'=>'','title'=>'Click here to activate '.$eachrow['DonationLevel']['level_name'])),
