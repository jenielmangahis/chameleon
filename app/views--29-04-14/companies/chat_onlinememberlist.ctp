                        <table width="100%" border="0" cellspacing="3" cellpadding="3" style="border: 2px solid #E8E8E8; height: 100%;"> 
                            <tr><td colspan="2" class="paddBot orangeTextBold" width="100%" height="100%" align="left">Members Online Now</td></tr>
                            <?php 
                                if($memberdetails){ 
                                ...
                                ?>
                                <tr>
                                    <td class="forName " colspan="2" align="center"> No member online.</td></tr>
                                <?php
                            }?>
                        </table>