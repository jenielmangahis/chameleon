...
<?php
 $cancel_url="/companies/eventlist";  
    ?>
...
<?php echo $form->create("Company", array("action" => "eventattending",'name' => 'eventattending', 'id' => "eventattending")); ?>
<span class="titlTxt">
Event Memebrs  - Attending
</span>
<div class="topTabs">
...
<li><a href="/companies/eventinvitation/<?php echo $eventid;?>" ><span>Invite</span></a></li>
<li><a href="/companies/eventattending/<?php echo $eventid;?>" class="tabSelt"><span>Attending</span></a></li>
<li><a href="/companies/eventmayattending/<?php echo $eventid;?>" ><span>May be Attending</span></a></li>
<li><a href="/companies/eventpending/<?php echo $eventid;?>"><span>Pending</span></a></li>
 </ul>
</div>
<div class="clear"></div>
</div>
...
<table cellspacing="10" cellpadding="0" align="center" width="100%">
                 ...
                 <tr>
                     <td width="100%" width="100%" colspan="2"><label class="boldlabel"> <strong><?php echo $this->data['Event']['title'];?></strong> - <strong> Attending Members</strong></label></td>
                 </tr>
           ...
           ?>
               ...
               <?php  $cnt++; } } else{
                   echo "<td colspan='10'> No Attending Members </td>";
               }?>        
                       </tr>
