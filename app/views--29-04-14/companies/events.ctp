                                ...
                                <?php 
                                    if(isset($eventdata)){
                                       ...
                                       <br /><br />
                                         ...
                                         <div class="margin4px" style="position: relative; width: 25%;"> 
                                        <?php
                                            if($eventrow['RecurringEvent']['small_pic'] !=''){
												echo $html->image('/img/'.$project_name.'/uploads/'.$eventrow['RecurringEvent']['small_pic'], array('class'=>'right','align'=>'top'));
											} else {
												echo $html->image('/img/'.$project_name.'/nologo.jpg', array('class'=>'right','align'=>'top','width'=>'150','height'=>'150'));
											}
										?> 
                                                    <div class="margin4px" style="padding-top: 20px; width: 220px;">
                                                    <b>Description:</b>
