        ...
        if(id !=""){
            if(op=="change"){	
                if(act=="active"){
                    ...
                    window.location=baseUrl+"companies/changestatus/"+id+"/Holder/0/holderslist/cngstatus";
                }
            }
            if(op=="del"){
...
<div class="titlCont"><div class="myclass">
        ...
        <div class="topTabs">
            <ul class="dropdown">
             ...
             <?php    $this->loginarea="companies";    $this->subtabsel="holderslist";
             echo $this->renderElement('memberlist_submenus');  ?>   
    </div></div>
<div class="midCont" id="holderlisttab">
    ...
    <div class="gryTop">
            ...
            <span class="srchBg2"><input type="button" value="Reset" label="" onclick="javascript:(window.location=baseUrl+'companies/holderslist')" id="locaa"></span>
            <span class="srchBg2"><input type="button" value="Csv file download" label="" onclick="jjavascript:(window.location=baseUrl+'companies/downloadholder')" > </span>
                    ...
                    <tr class='<?php echo $cls; ?>'>    
						...
						?>
                            ...
                            <td align="center" valign="middle" class='newtblbrd'>
								<a href='<?php echo $editmemnerpage;?>'><span><?php echo $points?$points:"0"; ?></span></a>
								<?php
									e($html->link(
...
<script type="text/javascript">
    if(document.getElementById("flashMessage")!=null)
        {		
        document.getElementById("holderlisttab").className = "newmidCont";
    }	
</script>
