<?php
    ...
    */
	...
	Router::connect('relationships/sa_addcompany/*', array('controller' => 'contacts', 'action' =>  'sa_addcompany'));
	Router::connect('relationships/sa_addcontacts/*', array('controller' => 'contacts', 'action' =>  'sa_addcontacts'));
	Router::connect('relationships/editlos/*', array('controller' => 'contacts', 'action' =>  'editlos'));
    ...
    //if($current_domain == 'www.chameleoncrm.net' || $current_domain == 'gocitiescms.com' )
   // {
        //echo "I am here";die;
